...
- Precompiles
- Ethereum Toolkit
url: https://docs.moonbeam.network/builders/ethereum/precompiles/features/governance/collective/
word_count: 2416
token_estimate: 4015
version_hash: sha256:6336effe65b4a793f4c6bea7087b60ea6b06b45cd278d540359be5f2469a08af
...
=== "Moonbeam"
     ...
     | OpenGov Technical Committee | 0x0000000000000000000000000000000000000814 |
...
[`Collective.sol`](https://github.com/moonbeam-foundation/moonbeam/blob/master/precompiles/collective/Collective.sol) is a Solidity interface that allows developers to interact with the precompile's five methods.
...
??? function "**execute**(*bytes memory* proposal) - executes a proposal as a single member of the collective. The sender must be a member of the collective. This will *not* revert if the Substrate proposal is dispatched but fails"
    ...
    === "Parameters"
        ...
        - `proposal` - bytes memory containing the [SCALE encoded](https://docs.polkadot.com/reference/parachains/data-encoding/) Substrate call that proposes an action
...
If you are not a member of the Treasury Council on Moonbeam, Moonriver, or Moonbase Alpha, you can test out the features of the Collective Precompile using a [Moonbeam development node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/). The Moonbeam development node comes with [ten pre-funded accounts](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/#pre-funded-development-accounts), of which Baltathar, Charleth, and Dorothy are automatically set as members of the Treasury Council collective. You can use any of these three accounts to follow along with the rest of the guide.
...
To get started, you will need to have the following:
 ...
 - Have MetaMask installed and [connected to one of the Moonbeam-based networks](/moonbeam-mkdocs/tokens/connect/metamask/)
...
- [Connect Polkadot.js Apps to your local Moonbeam development node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/#connecting-polkadot-js-apps-to-a-local-moonbeam-node)
- Import Baltathar's, Charleth's, and/or Dorothy's accounts into [Polkadot.js Apps](/moonbeam-mkdocs/tokens/connect/polkadotjs/#creating-or-importing-an-h160-account) and [MetaMask](/moonbeam-mkdocs/tokens/connect/metamask/#import-accounts)

### Remix Set Up {: #remix-set-up }

1. Get a copy of [`Collective.sol`](https://github.com/moonbeam-foundation/moonbeam/blob/master/precompiles/collective/Collective.sol) 
2. Copy and paste the file contents into a [Remix file](https://remix.ethereum.org) named `Collective.sol`

![Copying and Pasting the Collective Interface into Remix](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-1.webp)
...
![Compiling Collective.sol](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-2.webp)
...
![Access the precompile contract](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-3.webp)
...
![Submit a treasury proposal](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-4.webp)
...
![View all treasury proposals](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-5.webp)
...
![Get encoded proposal](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-6.webp)
...
![Propose the approval](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-7.webp)
...
![Get the proposal hash](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-8.webp)
...
![Vote on the proposal](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-9.webp)
...
![Close the proposal](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-10.webp)
...
![Review the treasury approvals](/moonbeam-mkdocs/images/builders/ethereum/precompiles/features/governance/collective/collective-11.webp)
