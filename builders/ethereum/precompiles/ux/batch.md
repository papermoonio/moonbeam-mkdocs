...
- Precompiles
- Ethereum Toolkit
url: https://docs.moonbeam.network/builders/ethereum/precompiles/ux/batch/
word_count: 3282
token_estimate: 4989
version_hash: sha256:c403948fdbc80d71485486fab5c2a907db4f26a7f16dbc4a5de550d54f964cab
...
[`Batch.sol`](https://github.com/moonbeam-foundation/moonbeam/blob/master/precompiles/batch/Batch.sol) is a Solidity interface that allows developers to interact with the precompile's three methods.
...
You can interact with the batch precompile using [Remix](https://remix.ethereum.org). You'll need a copy of [`Batch.sol`](https://github.com/moonbeam-foundation/moonbeam/blob/master/precompiles/batch/Batch.sol) and [`SimpleContract.sol`](#example-contract). To add the precompile to Remix and follow along with the tutorial, you will need to:
...
![Compiling Batch.sol](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-1.webp)
...
![Access the address](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-2.webp)
...
![Deploy SimpleContract](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-3.webp)
...
![Send Batch Transfer](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-4.webp)

Once the transaction is complete, be sure to check both of the accounts' balances, either in MetaMask or in a [block explorer](/moonbeam-mkdocs/builders/get-started/explorers/). Congratulations! You've now sent a batched transfer via the batch precompile.
...
![Transaction Call Data](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-5.webp)
...
![Batch Function Interaction](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-6.webp)
...
![SimpleContract Confirmation](/moonbeam-mkdocs/images/builders/ethereum/precompiles/ux/batch/batch-7.webp)
...
If you have followed the [Ethers.js tutorial](/moonbeam-mkdocs/builders/ethereum/libraries/ethersjs/) on Moonbeam, you may find it difficult to find the call data for a function. The answer is hidden within Ether's `Interface` object, where the [encodeFunctionData](https://docs.ethers.org/v6/api/abi/#Interface-encodeFunctionData) function allows you to input your function name and inputs to receive the resultant call data.
...
Afterwards, you should be all set to interact with the batch precompile as one typically would with a contract in [Ethers](/moonbeam-mkdocs/builders/ethereum/libraries/ethersjs/).
