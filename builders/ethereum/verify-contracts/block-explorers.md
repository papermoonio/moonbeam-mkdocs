...
categories:
- Ethereum Toolkit
url: https://docs.moonbeam.network/builders/ethereum/verify-contracts/block-explorers/
word_count: 1103
token_estimate: 1599
version_hash: sha256:ec6564fcdbdc8a194eb221fac3f318e9df151e5ab9a557510f37a46ee875eedb
...
In order to verify a smart contract on a block explorer, the contract must first be deployed on the target network. This tutorial will be about deploying the smart contract to [Moonbase Alpha](/moonbeam-mkdocs/builders/get-started/networks/moonbase/), but it can be adapted for Moonbeam or Moonriver.

You can check out this page for a tutorial on [deploying smart contracts](/moonbeam-mkdocs/builders/ethereum/libraries/) using Ethereum libraries on Moonbeam. You may also use a developer tool such as [Remix](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/#deploying-a-contract-to-moonbeam-using-remix), [Hardhat](/moonbeam-mkdocs/builders/ethereum/dev-env/hardhat/), or another tool if preferred, to deploy the smart contract to Moonbeam.
...
![Example Compiler Options in Remix IDE](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-1.webp)

![Contract Address in Remix IDE](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-2.webp)
...
![First Page Screenshot](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-3.webp)
...
![Second Page Screenshot](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-4.webp)
...
![Result Page Screenshot](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-5.webp)
...
![Moonscan Multifile Page](/moonbeam-mkdocs/images/builders/ethereum/verify-contracts/block-explorers/verify-contract-6.webp)
