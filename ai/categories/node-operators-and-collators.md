...
- reference
word_count: 92309
token_estimate: 189665
page_count: 44
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:70fe996190c66a9af6d01cdab2b187355edcfbb7ed56c637a91cee6f362747b3
---

# Begin New Bundle: Node Operators and Collators
...
Page Title: Author Mapping Precompile

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/author-mapping.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/author-mapping/
- Summary: A guide for collators to learn how to use the Author Mapping Solidity interface to map session keys to a Moonbeam address where block rewards are paid out. 
- Word Count: 1931; Token Estimate: 3317
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:f8d062373badb8fcd15ab6cc6f1a56673cf017025f556c11d6f4bb9b488b0c71
...
Page Title: Collator Account Management

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/account-management.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/account-management/
- Summary: Learn how to manage your collator account, including generating session keys, mapping Nimbus IDs, setting an identity, and creating proxy accounts.
- Word Count: 2606; Token Estimate: 4257
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:668cc2f55128e4151f00f1874098d908f8a99a6d75e9cc17a9fbdb7b0db15ebe
...
Page Title: Collators FAQ

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/faq.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/faq/
- Summary: Some FAQs around becoming a collator, collator activities, and things to be aware of when running and operating a collator node on Moonbeam.
- Word Count: 1520; Token Estimate: 2557
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:7c85a4fd270c77349d4600a12fdecfdff630dac658c82677cdd8e59f36189190
...
Page Title: Compile the Binary to Run a Node

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/run-a-node/compile-binary.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/run-a-node/compile-binary/
- Summary: Learn how to manually compile the binary to run a full Moonbeam node. Compiling the binary can take around 30 minutes and requires at least 32GB of memory.
- Word Count: 395; Token Estimate: 607
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:e8135365217b9a4093beda32ad8f3fad27b6c9fe17619d87a5a0b75eaa0b52b0
...
Page Title: Moonbeam Collator Activities

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/activities.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/activities/
- Summary: Instructions on how to dive in and learn about the related activities for becoming and maintaining a collator node in the Moonbeam Network.
- Word Count: 2774; Token Estimate: 4777
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:570a9a19694f3994e641ac53ad7ded42cf3ac01099578e042109211c02287fa1
...
Page Title: Moonbeam Collator Requirements

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/requirements.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/requirements/
- Summary: Learn about the requirements for becoming and maintaining a collator node on Moonbeam networks, including requirements for hardware, bonds, and more.
- Word Count: 1470; Token Estimate: 2478
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:a7021db35713becd6a114f239be41c0681209b6f5e4b7cfca51c61abe41f3e43
...
- Be active in the community
    - [Join the Discord](/moonbeam-mkdocs/node-operators/networks/collators/overview/#join-discord) and introduce yourself, provide updates as needed, and help support community members or other collators
- Create tutorials and educational content
- [Become a Moonbeam Ambassador](https://moonbeam.network/community/ambassador)
...
Collators must have a full node running with the collation options. To do so, follow the [Run a Node](/moonbeam-mkdocs/node-operators/networks/run-a-node/overview/) tutorial and installation steps for [Using Systemd](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/). Make sure you use the specific code snippets for collators.
...
=== "Moonbeam"
    |         Variable          |                          Value                           |
    |:-------------------------:|:--------------------------------------------------------:|
    | Minimum self-bond amount  |     100000 GLMR     |
    |      Active set size      | 64 collators |

=== "Moonriver"
    |         Variable          |                           Value                           |
    |:-------------------------:|:---------------------------------------------------------:|
    | Minimum self-bond amount  |     500 MOVR     |
    |      Active set size      | 72 collators |

=== "Moonbase Alpha"
    |         Variable          |                          Value                           |
    |:-------------------------:|:--------------------------------------------------------:|
    | Minimum self-bond amount  |     500 DEV      |
    |      Active set size      | 8 collators |

### Key Association Bond {: #key-association-bond }

Secondly, you will need a bond for key association. This bond is required when [mapping your author ID](/moonbeam-mkdocs/node-operators/networks/collators/account-management/) (session keys) with your account for block rewards, and is per author ID registered.

=== "Moonbeam"
    |   Variable   |                         Value                          |
    |:------------:|:------------------------------------------------------:|
    | Minimum bond | 10000 GLMR |

=== "Moonriver"
    |   Variable   |                          Value                          |
    |:------------:|:-------------------------------------------------------:|
    | Minimum bond | 100 MOVR |

=== "Moonbase Alpha"
    |   Variable   |                         Value                         |
    |:------------:|:-----------------------------------------------------:|
    | Minimum bond | 100 DEV |

## Collator Questionnaire {: #collator-questionnaire }

There is a [Collator Questionnaire](https://docs.google.com/forms/d/e/1FAIpQLSfjmcXdiOXWtquYlBhdgXBunCKWHadaQCgPuBtzih1fd0W3aA/viewform), that aims to assess the state of all collators on Moonbase Alpha. You should be running a collator node on Moonbase Alpha before filling out this form. You will be able to provide your contact information as well as some basic hardware specs. It provides a way to open the lines of communication between you and the Moonbeam team in case any problems with your node arise.
...
Page Title: Orbiter Program for Collators

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/orbiter.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/orbiter/
- Summary: Learn about the Moonbeam Orbiter Program for collators, including the eligibility criteria, bond requirements, rewards, performance metrics, and more.
- Word Count: 1526; Token Estimate: 2254
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:73d86abd3d3c7fcb199affc33d83a471b2df25af582ae4798e8b4efa0eba34e3

# Moonbeam Orbiter Program

## Introduction {: #introduction }

The Moonbeam Foundation is announcing a limited trial of the orbiter program. Similar to [Decentralized Nodes](https://nodes.web3.foundation/), this program allows collators to participate in the diversity and security of the network even if they do not have enough funds or backing to otherwise be in the active set. This program was developed with the input from the community.
...
- [Prepare your node by syncing it](/moonbeam-mkdocs/node-operators/networks/run-a-node/overview/)
- Once fully synced, you can [generate your session keys](/moonbeam-mkdocs/node-operators/networks/collators/account-management/#session-keys)
- [Register your session keys](/moonbeam-mkdocs/node-operators/networks/collators/account-management/#map-author-id-set-session-keys) and post the associated [mapping bond](#mapping-bond)
...
1. In [Polkadot.js Apps](https://polkadot.js.org/apps/#/chainstate), open the **Developer** tab, click **Chain state**, select `moonbeamOrbiters`, and submit `collatorsPool()` with no arguments, making sure to disable **include option**. Look for your orbiter's address beneath the collator pool address. Copy the collator pool address as you'll need it in a subsequent step. 
    ![`moonbeamOrbiters.collatorsPool()` Chain State Call in Polkadot.js](/moonbeam-mkdocs/images/node-operators/networks/collators/orbiter/orbiter-1.webp)

2. From the same [Polkadot.js Apps Chain State page](https://polkadot.js.org/apps/#/chainstate), select `moonbeamOrbiters`, and submit the `counterForCollatorsPool()` query. Make a note of that number as you'll need it in the final step.
    ![`moonbeamOrbiters.counterForCollatorsPool()` Chain State Call in Polkadot.js](/moonbeam-mkdocs/images/node-operators/networks/collators/orbiter/orbiter-2.webp)

3. In [Polkadot.js Apps](https://polkadot.js.org/apps/#/extrinsics), open the **Developer** tab, click **Extrinsics**, and submit the `moonbeamOrbiters.orbiterLeaveCollatorPool(collator)` extrinsic using the collator pool address from step 1 for the `collator` parameter.
    ![`moonbeamOrbiters.orbiterLeaveCollatorPool(collator)` Extrinsic Call in Polkadot.js](/moonbeam-mkdocs/images/node-operators/networks/collators/orbiter/orbiter-3.webp)

4. Stay on the **Developer** tab with **Extrinsics** selected and submit `moonbeamOrbiters.orbiterUnregister(collatorsPoolCount)` with the pool count captured in step 2.
    ![`moonbeamOrbiters.orbiterUnregister(collatorsPoolCount)` Extrinsic Call in Polkadot.js](/moonbeam-mkdocs/images/node-operators/networks/collators/orbiter/orbiter-4.webp)
...
Page Title: Run a Node Flags & Options

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/run-a-node/flags.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/run-a-node/flags/
- Summary: A list of helpful flags for spinning up a full parachain node on Moonbeam. Also learn how to access all of the flags available for node operators.
- Word Count: 2135; Token Estimate: 4187
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:45208dd2b85c4465972e4c6b7c199e3ad8b29ea5597788a8b34840d388b09776
...
- **`--ws-port`**: *deprecated as of [client v0.33.0](https://github.com/moonbeam-foundation/moonbeam/releases/tag/v0.33.0), use `--rpc-port` for HTTP and WS connections instead* - Sets the unified port for both HTTP and WS connections. The default port for parachains is `9944`  and `9945` for the embedded relay chain.
...
- **`--ws-max-connections`**: *deprecated as of [client v0.33.0](https://github.com/moonbeam-foundation/moonbeam/releases/tag/v0.33.0), use `--rpc-max-connections` to adjust the combined HTTP and WS connection limit instead* - Specifies the maximum number of HTTP and WS server connections. The default is 100.
- **`--wasm-execution`**: Specifies the method for executing Wasm runtime code. The available options are:
    - **`compiled`**: This is the default and uses the [Wasmtime](https://github.com/paritytech/wasmtime) compiled runtime.
    - **`interpreted-i-know-what-i-do`**: Uses the [wasmi interpreter](https://github.com/wasmi-labs/wasmi).
...
- **`--lazy-loading-remote-rpc`**: Allows [lazy loading](/moonbeam-mkdocs/node-operators/networks/run-a-node/overview/#lazy-loading) by relying on a specified RPC endpoint for network state until the node is fully synchronized e.g. `--lazy-loading-remote-rpc 'https://moonbeam.unitedbloc.com'`, as long as the specified RPC endpoint has sufficient rate limits to handle the expected load. Private (API key) endpoints are strongly recommended over public endpoints.
...
Page Title: Run a Node on Moonbeam Using Systemd

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/run-a-node/systemd.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/run-a-node/systemd/
- Summary: How to run a full parachain node so you can have your own RPC endpoint or produce blocks for the Moonbeam Network using Systemd.
- Word Count: 2843; Token Estimate: 5461
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:b629e28386a283843dcc91850a65735b2a73caea68e65f8adf204e57fb96407d
...
Page Title: Run a Tracing Node

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/tracing-node.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/tracing-node/
- Summary: Learn how to leverage Geth's Debug and Txpool APIs, and OpenEthereum's Trace module to run a tracing node on Moonbeam.
- Word Count: 3006; Token Estimate: 5788
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:51cefbd11d04eade63adf24f0bd7797f78beadbaa1a96493a2c3bfd74a8e5ba4
...
Page Title: Use Docker to Run a Node

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/run-a-node/docker.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/run-a-node/docker/
- Summary: How to run a full parachain node so you can have your own RPC endpoint or produce blocks for the Moonbeam Network using Docker.
- Word Count: 3048; Token Estimate: 6257
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:7f6d4f334d5ce1f6265e71ce01cb3b3eb1b3c9d6732fb6a4390d3c0f4e3d7fc9
