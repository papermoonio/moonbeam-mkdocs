---
category: JSON-RPC APIs
includes_base_categories: true
base_categories:
- basics
- reference
word_count: 74138
token_estimate: 156804
page_count: 35
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:a9ba3aed85390aba9b65027357cad726bb46ff13e55e03fde418a3a0397fa2cf
---

# Begin New Bundle: JSON-RPC APIs
...
Page Title: Debug & Trace Transactions

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/json-rpc/debug-trace.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/json-rpc/debug-trace/
- Summary: Check out the non-standard JSON-RPC methods included in Geth's Debug and Txpool APIs and OpenEthereum's Trace module, which are supported on Moonbeam.
- Word Count: 2909; Token Estimate: 4985
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:b33049169ade936dd083b2614f1f4e54f29069ae40110d1195135087434a5f55
...
To view a list of tracing RPC providers, please check out the [Network Endpoints](/moonbeam-mkdocs/builders/get-started/endpoints/#tracing-providers) page.

If you wish to set up your own tracing node, you can follow the [Running a Tracing Node](/moonbeam-mkdocs/node-operators/networks/tracing-node/) guide. The RPC HTTP endpoint of your tracing node should be at `http://127.0.0.1:9944` and your node should display similar logs to the following:
...
???+ function "debug_traceTransaction"
    ...
    This method attempts to replay a transaction in the same manner as it was executed on the network. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-debug#debugtracetransaction) for more information.
    ...
    === "Returns"
        ...
        - `structLogs` - an array of [objects containing a detailed log of each opcode](https://geth.ethereum.org/docs/developers/evm-tracing/built-in-tracers#struct-opcode-logger) executed during the transaction
...
???+ function "debug_traceBlockByNumber"
    ...
    This method attempts to replay a block in the same manner as it was executed on the network. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-debug#debugtraceblockbynumber) for more information.
...
???+ function "debug_traceBlockByHash"
    ...
    This method attempts to replay a block in the same manner as it was executed on the network. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-debug#debugtraceblockbyhash) for more information.
...
???+ function "debug_traceCall"
    ...
    This method executes an eth_call within the context of the given block using the final state of the parent block as the base. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-debug#debugtracecall) for more information.
...
???+ function "trace_filter"
    ...
    This method returns matching traces for the given filters. Refer to [Open Ethereum's documentation](https://openethereum.github.io/JSONRPC-trace-module#trace_filter) for more information.
    ...
    === "Parameters"
        ...
        You can configure [additional flags](/moonbeam-mkdocs/node-operators/networks/tracing-node/#additional-flags) when spinning up your tracing node to change the default values.
...
???+ function "txpool_content"
    ...
    Returns the details for all currently pending transactions waiting to be included in the next block(s) and all queued transactions for future execution. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-txpool#txpool-content) for more information.
...
???+ function "txpool_inspect"
    ...
    Returns a summary for all currently pending transactions waiting to be included in the next block(s) and all queued transactions for future execution. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-txpool#txpool-inspect) for more information.
...
???+ function "txpool_status"
    ...
    Returns the total number of transactions currently pending transactions waiting to be included in the next block(s) and all queued transactions for future execution. Refer to [Geth's documentation](https://geth.ethereum.org/docs/interacting-with-geth/rpc/ns-txpool#txpool-status) for more information.
...
Page Title: Subscribe to Ethereum-style Events on Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/json-rpc/pubsub.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/json-rpc/pubsub/
- Summary: Take a look at the non-standard Ethereum JSON-RPC methods supported on Moonbeam that offer publish-subscribe functionality for specific events.
- Word Count: 2174; Token Estimate: 4094
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:c08ae408ddf4bf6a9a0f5cc62cea3655c4804a6b8e9f44c767ca1cac9444f3c1
