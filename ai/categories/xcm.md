...
- reference
word_count: 94654
token_estimate: 193173
page_count: 43
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:1e24583723563e6d65f55987f6d009f5b72c0bd2e977114ae8b725572a693ce1
---

# Begin New Bundle: XCM
...
Page Title: Forum Templates for XCM Integrations

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/forum-templates.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/forum-templates/
- Summary: Learn about and how to craft the two posts you need to make on the Moonbeam Community Forum when creating a cross-chain integration with Moonbeam.
- Word Count: 596; Token Estimate: 825
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:d6967962880a0a78170539278d8742e34b52f14fd066b3e8934cb6b7cf53ffce

# Moonbeam Community Forum Templates for XCM Integrations

## Introduction {: #introduction }

When starting an XCM integration on Moonriver or Moonbeam MainNet, there are two preliminary posts that must be made on the [Moonbeam Community Forum](https://forum.moonbeam.network) so that the voting community has the chance to provide feedback. The two preliminary posts are an XCM disclosure and an XCM proposal. **This step is not necessary when connecting to Moonbase Alpha.**
...
The first post that should be made are the key disclosures within the [XCM Disclosures category](https://forum.moonbeam.network/c/xcm-hrmp/xcm-disclosures/15), which highlight key information that is important to a voter's decision. This post is only required when establishing an XCM integration; it is not necessary if the integration already exists and you only need to register an asset.
...
The second post is a preliminary draft of the proposal in the [XCM Proposals category](https://forum.moonbeam.network/c/xcm-hrmp/xcm-proposals/14). Once a proposal is submitted on-chain and available for voting, you must also add a description to it in either the [Moonbeam Polkassembly](https://moonbeam.polkassembly.io/opengov) or [Moonriver Polkassembly](https://moonriver.polkassembly.io/opengov).
...
Page Title: Moonbeam Routed Liquidity

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/mrl.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/mrl/
- Summary: Learn how to receive Moonbeam Routed Liquidity after establishing a cross-chain integration with a Moonbeam-based network.
- Word Count: 4605; Token Estimate: 8522
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:2c8c077b1fbe7b627f9e103221073945c5c7b321f8fc4b3c390369eed1b4a6d8
...
Page Title: Open a Cross-Chain Channel

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/xc-integration.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/xc-integration/
- Summary: Learn how to establish a cross-chain integration with a Moonbeam-based network. Including opening and accepting an HRMP channel and registering assets.
- Word Count: 4041; Token Estimate: 6682
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:3c9726d356dadb96d256139693da80f256a5127873442317c006126676ddaec0
...
All of the examples in this guide use a CLI tool developed to ease the entire process, which you can find in the [xcm-tools GitHub repository](https://github.com/Moonsong-Labs/xcm-tools).
...
3. Once your node is fully synced, please get in touch with the Moonbeam team on [Telegram](https://t.me/Moonbeam_Official) or [Discord](https://discord.com/invite/PfpUATX), so the team can onboard your parachain to the relay chain. Provide the following information for onboarding:
   ...
   - The encoded call data to open an HRMP channel to your parachain, accept the incoming HRMP channel, and [register the assets](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registrationassets/#register-xc-20s) (if applicable). This will be executed through sudo
...
6. (Optional) [Register Moonbase Alpha's DEV token](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registrationassets/#register-moonbeam-native-assets) on your parachain
...
![Moonbase Alpha cross-chain integration process](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc-registration/xc-integration/channels-1.webp)

Once all of these steps are completed and both teams have successfully tested asset transfers, your parachain token can be added to the **Cross Chain Assets** section of the [Moonbeam DApp](https://apps.moonbeam.network/moonbase-alpha). If deposits and withdrawals work as expected, integration with Moonriver can begin.

### Sync a Node {: #sync-a-node }

To sync a node, you can use the [Alphanet relay chain specs](https://raw.githubusercontent.com/moonbeam-foundation/moonbeam/refs/heads/master/specs/alphanet/westend-embedded-specs-v8.json) (note: the relay chain is Westend-based, and will probably take one day to sync).

For reference, you can use [Moonbase Alpha's spec file](https://raw.githubusercontent.com/moonbeam-foundation/moonbeam/runtime-1103/specs/alphanet/parachain-embedded-specs-v8.json). You'll need to adapt it to your chain.
...
You can calculate the Sovereign account information using [a script from the xcm-tools repository](https://github.com/Moonsong-Labs/xcm-tools). To run the script, you must provide the parachain ID and the name of the associated relay chain.

You can find the parachain IDs that have already been used on the [relay chain's Polkadot.js Apps page](https://polkadot.js.org/apps/?rpc=wss://relay.api.moonbase.moonbeam.network#/parachains).
...
Please check the HRMP channel guidelines that the community voted on for [Moonriver](https://moonriver.polkassembly.io/referenda/0) and [Moonbeam](https://moonbeam.polkassembly.io/proposal/21) before starting.
...
2. Create [two Moonbeam Community forum posts](#create-forum-posts) with some key information for the XCM integration:
   - An [XCM Disclosure post](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registration/forum-templates/#xcm-disclosure), where you'll provide some disclosures about the project, the code base, and social network channels
   - An [XCM Proposal post](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registration/forum-templates/#xcm-proposals), where you'll provide some technical information about the proposal itself
3. Create a batch proposal on Moonbeam/Moonriver to:
   ...
   3. Register the asset as an [XC-20 token](/moonbeam-mkdocs/builders/interoperability/xcm/xc20/overview/) (if applicable)

   Proposals should be done in the General Admin Track from [OpenGov](/moonbeam-mkdocs/learn/features/governance/#opengov). The normal enactment times are as follows:

   - **Moonriver** - the Decision Period is approximately 14 days and the enactment time is at least 1 day
   - **Moonbeam** - the Decision Period is approximately 14 days and the enactment time is at least 1 day
...
![Moonbeam and Moonriver cross-chain integration process](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc-registration/xc-integration/channels-2.webp)

Once these steps are successfully completed, marketing efforts can be coordinated, and the new XC-20 on Moonriver/Moonbeam can be added to the **Cross Chain Assets** section of the [Moonbeam DApp](https://apps.moonbeam.network).

### Create Forum Posts {: #create-forum-posts }

To create forum posts on the [Moonbeam Community Forum](https://forum.moonbeam.network), you'll need to make sure that you're adding the posts to the correct category and adding relevant content. For general guidelines and templates to follow, please refer to the [Moonbeam Community Forum Templates for XCM Integrations](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registration/forum-templates/#) page.
...
1. [WithdrawAsset](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#withdraw-asset) - takes funds out of the Sovereign account (in the relay chain) of the origin parachain to a holding state
2. [BuyExecution](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#buy-execution) - buys execution time from the relay chain to execute the XCM message
3. [Transact](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#transact) - provides the relay chain call data to be executed. In this case, the call will be an HRMP extrinsic

!!! note
    You can add [DepositAsset](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#deposit-asset) to refund the leftover funds after the execution. If this is not provided, no refunds will be made. In addition, you could also add a [RefundSurplus](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#refund-surplus) after [Transact](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/instructions/#transact) to get any leftover funds not used for the Transact. But you'll have to calculate if it is worth paying the execution cost of the extra XCM instructions.

To send these XCM messages to the relay chain, the [Polkadot XCM Pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-v1.17.1/polkadot/xcm/pallet-xcm) is typically invoked. Moonbeam also has an [XCM Transactor Pallet](/moonbeam-mkdocs/builders/interoperability/xcm/remote-execution/substrate-calls/xcm-transactor-pallet/) that simplifies the process into a call that abstracts the XCM messaging constructor.

You could potentially generate the calldata for an HRMP action by using Polkadot.js Apps, but the [xcm-tools GitHub repository](https://github.com/Moonsong-Labs/xcm-tools) can build it for you, and it is the recommended tool for this process.
...
The xcm-tools repository has a specific script for HRMP interactions called [`hrmp-channel-manipulator.ts`](https://github.com/Moonsong-Labs/xcm-tools/blob/main/scripts/hrmp-channel-manipulator.ts). This command generates encoded calldata for a specific HRMP action, as long as it is given the correct details. The script builds the XCM message with the DepositAsset XCM instruction but not with RefundSurplus.
...
Fortunately, the [xcm-tools](https://github.com/Moonsong-Labs/xcm-tools) GitHub repository's `hrmp-channel-manipulator.ts` script can build the XCM for you!
...
Please refer to the [README](https://github.com/Moonsong-Labs/xcm-tools/tree/main#hrmp-manipulator-script) for a complete list of the arguments, including optional arguments, and examples on how to use the HRMP-manipulator script.
...
The most efficient way to complete the XCM process on parachains is to batch all transactions together. The [xcm-tools repository](https://github.com/Moonsong-Labs/xcm-tools) provides a script to batch extrinsic calls into a single call, thus requiring only a single transaction. This can be helpful if your parachain would like to open an HRMP channel and register an asset simultaneously. This **should be used** when proposing channel registration on a Moonbeam network.

If you are registering an asset in addition to establishing a channel, please refer to the [How to Register Cross-Chain Assets](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registrationassets/) guide to learn how to generate the encoded calldata required for asset registration.

The process of batching all of the transactions into one is depicted in the following diagram.

![Batch XCM integration process](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc-registration/xc-integration/channels-3.webp)
...
- `REGISTER_ASSET_CALL` is the SCALE encoded calldata for [registering a cross-chain asset](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registrationassets/#register-xc-20s). If you have more than one asset to be registered on Moonbeam, you can include additional registration SCALE encoded calldata with additional `--call` flags
...
With the encoded calldata, you can then submit the governance proposal. For Moonbeam and Moonriver, you must assign the proposal to the General Admin Track. It is recommended to become familiar with the [OpenGov: Governance v2 process on Moonbeam-based networks](/moonbeam-mkdocs/learn/features/governance/#opengov).
...
The [xcm-tools GitHub repository](https://github.com/Moonsong-Labs/xcm-tools) and most of its functions can be called with some additional flags that create some wrappers around the actions being taken. For example, you might want to wrap the send of the XCM message in sudo, or via a democracy proposal.
...
Page Title: Self-Serve Asset Registration

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/self-serve-asset-registration.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc-registration/self-serve-asset-registration/
- Summary: This guide shows sibling parachains how to register native tokens as foreign assets on Moonbeam via ForeignAssetOwnerOrigin to unlock ERC-20 UX on Moonbeam.
- Word Count: 1236; Token Estimate: 2395
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:d78003ced4b902171fe75cbbf389ae5976af2a585467440b3857099f21384051
...
- The sibling parachain's [sovereign account](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/sovereign-accounts/) on Moonbeam must be sufficiently funded to cover the asset deposit and the transaction fees. It's recommended that you have an extra buffer of additional funds for any subsequent transactions. See this [guide to calculating a sovereign account](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/sovereign-accounts/)
- Your parachain should support XCM V4
- Your parachain needs bidirectional XCM channels with Moonbeam. See this [guide for information on opening XCM channels with Moonbeam](/moonbeam-mkdocs/builders/interoperability/xcm/xc-registration/xc-integration/) 
...
Page Title: Send, Execute and Test XCM Messages

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/send-execute-xcm.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/send-execute-xcm/
- Summary: Build a custom XCM message, verify its construction and integrity using the XCM Dry Run API, and then execute it locally on Moonbeam to observe the results.
- Word Count: 5636; Token Estimate: 10230
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:a5e375c067be69c3e0cb20bd62d032d9fabc1d46a93c238a00a235f42192297e
...
Page Title: Sovereign Accounts and Reserve-Backed Transfers

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/sovereign-accounts.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/sovereign-accounts/
- Summary: Discover how sovereign accounts work on Moonbeam, how to calculate them, and their role in cross-chain asset transfers.
- Word Count: 539; Token Estimate: 824
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:3b5043d7164ec7bbcd41c77d5e01c4758b6289fc87dd213e476464d10e44cb2e
...
Page Title: XCM Execution Fees

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/weights-fees.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/weights-fees/
- Summary: Learn about the XCM instructions involved in handling XCM execution fee payments and how to calculate fees on Polkadot, Kusama, and Moonbeam-based networks.
- Word Count: 3815; Token Estimate: 7072
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:48cdf07f0974ea0c76a273cc9e1caf90baa3de0096386c8a27983e965752f871
...
Page Title: XCM Multilocations

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/multilocations.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/multilocations/
- Summary: Learn everything there is to know about multilocations, their role in XCM, and how to format a multilocation to target a specific point in the ecosystem.
- Word Count: 1320; Token Estimate: 2623
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:07f968fb39ebc0b1ba72aaecdd415e0ebfd5278ed1df08f86a7e738dd7a44596
...
![Hierarchy of multilocations](/moonbeam-mkdocs/images/builders/interoperability/xcm/core-concepts/multilocations/multilocations-1.webp)
...
- `Plurality` - describes multiple elements that meet specific conditions or share common characteristics. This requires you to specify the [Body ID](https://github.com/paritytech/polkadot-sdk/blob/polkadot-v1.17.1/polkadot/xcm/src/v3/junction.rs#L150-L176) and the [Body Part](https://github.com/paritytech/polkadot-sdk/blob/polkadot-v1.17.1/polkadot/xcm/src/v3/junction.rs#L222-L251) that the Junction represents
...
The Location to Account API is an easy way to convert a multilocation into an `AccountID20` address. The Location to Account API can be accessed from the [Runtime Calls](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbeam.network#/runtime) tab of the **Developer** section of Polkadot.js Apps. The `convertLocation` method of the Location to Account API takes a multilocation as a parameter and returns an `AccountID20` address.
...
Page Title: XCM Precompile

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc20/send-xc20s/eth-api.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc20/send-xc20s/eth-api/
- Summary: Learn about the XCM Precompile and how to use it to transfer assets from Moonbeam networks to other parachains.
- Word Count: 3179; Token Estimate: 5267
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:604588c6f003353df3c6d950e02749ce7ec5e240a7ee98ae24b2897b2f05b843
...
The communication protocol enabling token transfers is built on [Substrate](/moonbeam-mkdocs/builders/substrate/) and runs on a lower level than the EVM, making it harder for EVM developers to access.
...
This guide will show you how to interact with the [XCM Interface](https://github.com/Moonsong-Labs/moonkit/blob/main/precompiles/pallet-xcm/XcmInterface.sol) precompile to execute cross-chain token transfers through the Ethereum API.
...
The [`XCMInterface.sol`](https://github.com/Moonsong-Labs/moonkit/blob/main/precompiles/pallet-xcm/XcmInterface.sol) is a Solidity interface that allows developers to interact with the methods of `pallet-xcm`.
...
To follow this tutorial, you must have your preferred EVM wallet configured and an account funded with native tokens. You can add Moonbeam to MetaMask wallet following this guide: [Interacting with Moonbeam Using MetaMask](/moonbeam-mkdocs/tokens/connect/metamask/).

### Remix Set Up {: #remix-set-up }

You can interact with the XCM Precompile using [Remix](https://remix.ethereum.org). To add the precompile to Remix, you will need to:

1. Get a copy of [`XCMInterface.sol`](https://github.com/Moonsong-Labs/moonkit/blob/main/precompiles/pallet-xcm/XcmInterface.sol)
...
![Compiling XCMInterface.sol](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-1.webp)
...
![Access the address](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-2.webp)
...
![Confirm Approve Transaction](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-3.webp)
...
![Confirm Approve Transaction](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-4.webp)
...
![Confirm Approve Transaction](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-5.webp)
...
4. Enter the index of the asset that will be used to pay the fees. This index is zero-based, so the first element is `0`, the second is `1`, and so on
5. Enter the XCM message to be executed on destination chain. For more information about creating XCM call data see [Send and Execute XCM Messages](/moonbeam-mkdocs/builders/interoperability/xcm/send-execute-xcm/)  
...
![Confirm Approve Transaction](/moonbeam-mkdocs/images/builders/interoperability/xcm/xc20/send-xc20s/eth-api/eth-api-6.webp)
...
Page Title: XCM Utilities Precompile Contract

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xcm-utils.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xcm-utils/
- Summary: Learn the various XCM related utility functions available to smart contract developers with Moonbeam's precompiled XCM Utilities contract.
- Word Count: 632; Token Estimate: 1008
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:f4f08c7151d832f301cdf6217c49dceb132262ab82e418ec703ccf29d071f1da
