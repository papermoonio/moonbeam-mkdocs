---
category: GMP Providers
includes_base_categories: true
base_categories:
- basics
- reference
word_count: 76009
token_estimate: 158216
page_count: 36
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:4e01a4b6b4b23790d2b4a019a44d6e6ee58ffbdef4b16d47c33f542f3c69a8f9
---

# Begin New Bundle: GMP Providers
...
Page Title: Cross-Chain Via Axelar

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/protocols/axelar.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/protocols/axelar/
- Summary: Learn about Axelar, a GMP protocol for cross-chain asset transfers, and how to get started building cross-chain applications with Axelar on Moonbeam.
- Word Count: 649; Token Estimate: 913
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:1395b24a27ced6a7970be83bb4b20cbfe5125e92146fe2086f68474eb9adbf89

# Axelar Network

## Introduction {: #introduction }

[Axelar](https://www.axelar.network) delivers secure cross-chain communication for Web3. Axelar's infrastructure enables dApp users to interact with any asset or application, on any connected chain, with one click. Powered by a permissionless Proof-of-Stake validator set, Axelar network allows dApps to pass arbitrary messages across chains using Turing-complete calls.

Axelar is a full-stack transport layer that supports asset transfer, [General Message Passing](https://docs.axelar.dev/dev/general-message-passing/overview) and composability of programs. It securely connects all blockchain ecosystems, applications, assets and users to deliver Web3 interoperability. Axelar is composed of a decentralized network of validators, secure gateway contracts, uniform translation, routing architecture, and a suite of protocols and application programming interfaces (APIs). Take a look at the [Tech Stack Diagram](https://www.axelar.network/blog/an-introduction-to-the-axelar-network) for more details.

![Axelar Technology Stack diagram](/moonbeam-mkdocs/images/builders/interoperability/protocols/axelar/axelar-1.webp)
...
- **[Developer documentation](https://docs.axelar.dev/dev/intro)** - for technical guides
- **[Squid](https://app.squidrouter.com/)** - a bridging UI used to transfer assets across chains
...
- **[Axelarscan for TestNet](https://testnet.axelarscan.io)**

## Contracts {: #contracts }

See the list of Axelar contracts deployed to Moonbeam, and the networks connected to Moonbeam through Axelar.

- **MainNet Contracts** - [Moonbeam](https://docs.axelar.dev/dev/reference/mainnet-contract-addresses)

- **TestNet Contracts** - [Moonbase Alpha](https://docs.axelar.dev/dev/reference/testnet-contract-addresses)
...
Page Title: Cross-Chain Via LayerZero

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/protocols/layerzero.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/protocols/layerzero/
- Summary: Learn about LayerZero, a GMP protocol for cross-chain asset transfers, and how to get started building cross-chain applications with LayerZero on Moonbeam.
- Word Count: 589; Token Estimate: 772
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:86e1212b3d4daf64421de869a37f4fd56a31ab7848bf3004792b0abf6c8bacf1

# LayerZero Protocol

## Introduction {: #introduction }

[LayerZero](https://layerzero.network) delivers secure omnichain interoperability for Web3. It consists of an Oracle actor and a Relayer actor that work separately to provide secure messages from one chain to another. LayerZero's infrastructure enables dApp users to interact with any asset or application, on any connected chain, with one click.

LayerZero is a transport layer that enables asset transfer with low-level communication primitives. DApps that utilize LayerZero are known as User Applications, whose messages are relayed across chains by a Relayer, and whose messages are verified on the destination chain by an Oracle's block headers. Take a look at the tech stack diagram below and their [conceptual documentation](https://docs.layerzero.network/v2/concepts/getting-started/what-is-layerzero) for more details.

![LayerZero Technology Stack diagram](/moonbeam-mkdocs/images/builders/interoperability/protocols/layerzero/layerzero-1.webp)
...
- **[Developer documentation](https://docs.layerzero.network/v2/get-started/overview)**: For technical guides.
- **[Stargate](https://stargate.finance)**: A bridging UI that uses LayerZero, built by the Stargate team.

## Contracts {: #contracts }

Explore the list of LayerZero contracts deployed and find Moonbeam or Moonriver within the [LayerZero deployed contracts](https://docs.layerzero.network/v2/deployments/deployed-contracts).
...
Page Title: Cross-Chain via Wormhole

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/protocols/wormhole.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/protocols/wormhole/
- Summary: Learn how to bridge assets, set up a relayer, and other ways you can connect your Moonbeam DApp to assets and functions on multiple blockchains using Wormhole.
- Word Count: 5716; Token Estimate: 8806
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:16b5616d53ce1cef8f546c27773a1e509e30e353b509c37ad08ea0698473c0cc
