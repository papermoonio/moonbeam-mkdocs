...
- reference
word_count: 85536
token_estimate: 175908
page_count: 38
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:dda8879c39c77f5e72ef60db4b00d08df866c9c8531dbc6ec3a35984446d4988
---

# Begin New Bundle: Dev Environments
...
Page Title: Deploy Contracts with Foundry

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/dev-env/foundry.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/dev-env/foundry/
- Summary: Learn how to use Foundry, an Ethereum development environment, to compile, deploy, and debug Solidity smart contracts on Moonbeam.
- Word Count: 5191; Token Estimate: 9594
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:e9b8c453d0e66b0a9eaa75d30ca20aca4402ea0298dccab5999748f4542d6e90
...
Page Title: Deploy Contracts with Hardhat

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/dev-env/hardhat.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/dev-env/hardhat/
- Summary: Learn how to use Hardhat, an Ethereum development environment, to compile, deploy, and debug Solidity smart contracts on Moonbeam.
- Word Count: 4376; Token Estimate: 7639
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:7c77f674ed5169f93ba6f0d15b97c0931ec5ece9bda23bed69e110de61cb4ce2
...
Page Title: Deploy Smart Contracts with Remix

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/dev-env/remix.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/dev-env/remix/
- Summary: Discover how to deploy and interact with Solidity smart contracts on Moonbeam using the Remix IDE, one of the most widely used Ethereum development tools.
- Word Count: 3136; Token Estimate: 4527
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:3790860302cf27f0a0da8c2f0cf3704fcd850b1a82aa95934155114e7a79eac6
...
[Remix](https://remix.ethereum.org) is an integrated development environment (IDE) for developing smart contracts on Ethereum and Ethereum-compatible chains. It provides an easy-to-use interface for writing, compiling, and deploying smart contracts. Given Moonbeam’s Ethereum compatibility features, you can use Remix directly with any Moonbeam network.

This guide walks through the process of creating and deploying a Solidity smart contract to a [Moonbeam development node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/) using the Remix IDE. This guide can be adapted for [Moonbeam](/moonbeam-mkdocs/builders/get-started/networks/moonbeam/), [Moonriver](/moonbeam-mkdocs/builders/get-started/networks/moonriver/), or [Moonbase Alpha](/moonbeam-mkdocs/builders/get-started/networks/moonbase/).

If you're familiar with Remix, you can skip ahead to the [Connect Remix to Moonbeam](#connect-remix-to-moonbeam) section to learn how to use Remix with Moonbeam.

## Checking Prerequisites {: #checking-prerequisites }

For the purposes of this guide, you'll need to have the following:

- A locally running [Moonbeam development node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/)
- [MetaMask installed and connected](/moonbeam-mkdocs/tokens/connect/metamask/) to your development node
...
Your development node comes with 10 pre-funded accounts. You should have MetaMask connected to your Moonbeam development node and have imported at least one of the pre-funded accounts. You can refer to the [Import Accounts](/moonbeam-mkdocs/tokens/connect/metamask/#import-accounts) section of the MetaMask docs for step-by-step instructions on how to import a development account.

![The main screen of MetaMask, which shows an account connected to a Moonbeam development node and its balance.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-1.webp)
...
If you navigate to [https://remix.ethereum.org/](https://remix.ethereum.org), you'll see that the layout of Remix is split into four sections:
...
![The layout of Remix IDE and its four sections.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-2.webp)
...
![Create a new file using the File explorer plugin in Remix.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-3.webp)
...
![Add the contract code to the newly created file in the main panel of Remix.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-4.webp)
...
Make sure that the compiler version in the top-left corner meets the version defined in your contract and the version defined in [OpenZeppelin's `ERC20.sol` contract](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/ERC20.sol). For example, the `MyToken.sol` contract requires Solidity ^0.8.30, and OpenZeppelin's `ERC20.sol` contract is compatible with ^0.8.30, so the compiler needs to be set to version 0.8.30 or newer.
...
![The Solidity compiler plugin shown in the side panel in Remix.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-5.webp)
...
For example, if you only provided the token name to the ERC-20 constructor but forgot the token symbol and tried to compile the contract, an error would appear in the side panel. You can scroll down to read the error, and you'll see that there is also an **ASK GPT** button. To get help debugging the issue, you can click on **ASK GPT**, and a response will be returned in the Remix terminal that will guide you in the right direction to try and fix the issue. If you need additional help, you can go straight to the source and ask [ChatGPT](https://chatgpt.com/) directly.

![An error message shown in the side panel for the Solidity compiler plugin with an ASK GPT button for debugging.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-6.webp)
...
![The green check mark next to the Solidity compiler plugin in the plugin panel.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-7.webp)
...
For this example, MetaMask will be used. You should already have MetaMask installed and connected to your local Moonbeam development node. If not, please refer to the [Interacting with Moonbeam Using MetaMask](/moonbeam-mkdocs/tokens/connect/metamask/) guide for step-by-step instructions.

From the **ENVIRONMENT** dropdown, select **Injected Provider - MetaMask**.

![The environment dropdown on the Deploy and run transactions side panel expanded to reveal all of the available options.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-8.webp)
...
![Two MetaMask screens that you must go through to connect to Remix: one that prompts you to choose an account to connect to and another that grants Remix permissions.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-9.webp)
...
![The Deploy and run transactions side panel in Remix showing the environment connected to MetaMask, the connected network as 1281, and the connected account address.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-10.webp)
...
![The Deploy and run transactions side panel completely filled out to perform a contract deployment.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-11.webp)
...
![A view of the functions available in the deployed ERC-20 contract and the response from calling the totalSupply function.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-12.webp)
...
![The inputs for the approve function of the ERC-20 contract and the MetaMask pop-up for the approval.](/moonbeam-mkdocs/images/builders/ethereum/dev-env/remix/remix-13.webp)

To view your balance or approvals, or transfer MYTOKs, you can add the MYTOK to your wallet. For information on how to add a token to MetaMask, you can refer to the [Add an ERC-20 Token](/moonbeam-mkdocs/tokens/connect/metamask/#add-erc20) section of [our MetaMask documentation](/moonbeam-mkdocs/tokens/connect/metamask/).
...
Page Title: How to use Chopsticks to Fork Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/builders/substrate/dev-env/chopsticks.md
- Canonical (HTML): https://docs.moonbeam.network/builders/substrate/dev-env/chopsticks/
- Summary: Learn the basics of how to use Chopsticks to replay blocks, dissect state changes, test XCM interactions, and locally fork the entirety of a Moonbeam network.
- Word Count: 2061; Token Estimate: 3950
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:a412b55431e4ca4df8ce3ac4019b392309c6eb49f4daada4696d4d0b31655877

# How to Use Chopsticks to Fork Moonbeam

## Introduction {: #introduction }

[Chopsticks](https://github.com/AcalaNetwork/chopsticks) provides a developer-friendly method of locally forking existing Substrate based chains. It allows for the replaying of blocks to easily examine how extrinsics affect state, the forking of multiple blocks for XCM testing, and more. This allows developers to test and experiment with their own custom blockchain configurations in a local development environment, without the need to deploy a live network.  
...
To use Chopsticks, you can install it as a package with the [Node package manager](https://nodejs.org/en) or [Yarn](https://yarnpkg.com):  
...
To run Chopsticks, you will need some sort of configuration, typically through a file. Chopsticks' source repository includes a set of [YAML](https://yaml.org) configuration files that can be used to create a local copy of a variety of Substrate chains. You can download the configuration files from the [source repository's `configs` folder](https://github.com/AcalaNetwork/chopsticks).  
...
!!! note
    If using a file path, make sure you've downloaded the [Moonbeam configuration file](https://github.com/AcalaNetwork/chopsticks/blob/master/configs/moonbeam.yml), or have created your own.
...
You will be able to interact with the parachain via libraries such as [Polkadot.js](https://github.com/polkadot-js/common) and its [user interface, Polkadot.js Apps](https://github.com/polkadot-js/apps).  

You can interact with Chopsticks via the [Polkadot.js Apps hosted user interface](https://polkadot.js.org/apps/#/explorer). To do so, visit the page and take the following steps:  
...
![Open WSS](/moonbeam-mkdocs/images/builders/substrate/dev-env/chopsticks/chopsticks-1.webp)
![Switch WSS](/moonbeam-mkdocs/images/builders/substrate/dev-env/chopsticks/chopsticks-2.webp)

You should now be able to interact with the fork as you would an active parachain or relay chain.

!!! note
    If your browser cannot connect to the WebSocket endpoint provided by Chopsticks, you might need to allow insecure connections for the Polkadot.js Apps URL. Another solution is to run the [Docker version of Polkadot.js Apps](https://github.com/polkadot-js/apps#docker).
...
Page Title: Tenderly Development Platform

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/dev-env/tenderly.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/dev-env/tenderly/
- Summary: Learn how to use Tenderly, an Ethereum development platform, to build, debug, and monitor Solidity smart contracts on Moonbeam.
- Word Count: 1717; Token Estimate: 2473
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:af6b2627d4535876991109d53731e4c47244d4ed4c36f3e2ca335cd852f6c074
