---
category: Oracle Nodes
includes_base_categories: true
base_categories:
- basics
- reference
word_count: 71783
token_estimate: 152465
page_count: 35
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:40b6ee263c8954a77019fbff27cd408b8b898d26e4ff8f82907570150879ee87
---

# Begin New Bundle: Oracle Nodes
...
Page Title: Request Off-Chain Data with API3

- Resolved Markdown: https://docs.moonbeam.network/builders/integrations/oracles/api3.md
- Canonical (HTML): https://docs.moonbeam.network/builders/integrations/oracles/api3/
- Summary: Learn how to use API3 to request and receive off-chain data from within your smart contracts using API3 Airnodes and dAPIs (data feeds) on Moonbeam networks.
- Word Count: 1954; Token Estimate: 3308
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:c818b9bda96ab8e45bb40d557cd2a8f97253d1ca18e5e0c7574d6990ec638110
...
![A diagram detailing the process of requesting off-chain data from an Airnode.](/moonbeam-mkdocs/images/builders/integrations/oracles/api3/api3-2.webp)
...
You can also try [deploying the example contract on Remix](https://remix.ethereum.org/#url=https://github.com/api3-ecosystem/remix-contracts/blob/master/contracts/RequesterWithWithdrawal.sol&optimize=false&runs=200&evmVersion=null&version=soljson-v0.8.9+commit.e5eed63a.js).

### Contract Addresses {: #contract-addresses }

The `_rrpAddress` is the main `airnodeRrpAddress`. The RRP contracts have already been deployed on-chain. The [addresses for the `_rrpAddress`](https://airnode-docs.api3.org/reference/airnode/latest/) on Moonbeam networks are as follows:
...
- [**`airnode`**](https://airnode-docs.api3.org/reference/airnode/latest/concepts/airnode.html) - specifies the Airnode address
- [**`endpointId`**](https://airnode-docs.api3.org/reference/airnode/latest/concepts/endpoint.html) - specifies which endpoint to be used
- [**`sponsor`**](https://airnode-docs.api3.org/reference/airnode/latest/concepts/sponsor.html) and [**`sponsorWallet`**](https://airnode-docs.api3.org/reference/airnode/latest/concepts/sponsor.html#sponsorwallet) - specifies which wallet will be used to fulfill the request
- [**`parameters`**](https://airnode-docs.api3.org/reference/airnode/latest/specifications/reserved-parameters.html) - specifies the API and Reserved Parameters (see [Airnode ABI specifications](https://airnode-docs.api3.org/reference/airnode/latest/specifications/airnode-abi.html) for how these are encoded). Parameters can be encoded off-chain using the `@airnode-abi` library

### Response Parameters {: #response-params }

The callback to the requester contract contains two parameters:

- [**`requestId`**](https://airnode-docs.api3.org/reference/airnode/latest/concepts/request.html#requestid) - first acquired when making the request and passed here as a reference to identify the request for which the response is intended
...
[dAPIs](https://docs.api3.org/oev/in-depth/data-feeds/#data-feeds) are continuously updated streams of off-chain data, such as the latest cryptocurrency, stock, and commodity prices. They can power decentralized applications such as DeFi lending, synthetic assets, stablecoins, derivatives, NFTs, and more.
...
![The API3 Market dashboard.](/moonbeam-mkdocs/images/builders/integrations/oracles/api3/api3-3.webp)

To learn more about how dAPIs work, please refer to [API3's documentation](https://docs.api3.org/oev/in-depth/data-feeds/#data-feeds).

### Subscribe to dAPIs {: #subscribing-to-dapis }

The [API3 Market](https://market.api3.org/) lets users access dAPIs on [Moonbeam](https://market.api3.org/moonbeam), [Moonriver](https://market.api3.org/moonriver), and the [Moonbase Alpha TestNet](https://market.api3.org/moonbeam-testnet) (currently labeled as the Moonbeam TestNet).

From the [API3 Market home page](https://market.api3.org/), you can search for a given chain. After selecting the chain, you can view the list of available dAPIs and click on one for more information. For example, you can click on the `USDT/USD` pair available for Moonbeam to view the parameters of the dAPI, including the deviation and the heartbeat.
...
![The USDT/USD dAPI detail page.](/moonbeam-mkdocs/images/builders/integrations/oracles/api3/api3-4.webp)
...
![The activate data feed page.](/moonbeam-mkdocs/images/builders/integrations/oracles/api3/api3-5.webp)
...
![The integrate data feed page.](/moonbeam-mkdocs/images/builders/integrations/oracles/api3/api3-6.webp)
...
- [API3 Market](https://market.api3.org/moonbeam)
- [API3 Docs](https://docs.api3.org)
- [API3 DAO GitHub](https://github.com/api3dao)
- [API3 Medium](https://medium.com/api3)
- [API3 YouTube](https://www.youtube.com/API3DAO)
...
Page Title: Supra Oracles

- Resolved Markdown: https://docs.moonbeam.network/builders/integrations/oracles/supra.md
- Canonical (HTML): https://docs.moonbeam.network/builders/integrations/oracles/supra/
- Summary: Supra's Pull Oracle provides low-latency, on-demand price feed updates for a variety of use cases. Learn how to integrate Supra's oracle on Moonbeam.
- Word Count: 774; Token Estimate: 1432
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:531c23b7fb87f4f56f43655b8765eadb95bee84b82e44ee77e54624050eb02c6
