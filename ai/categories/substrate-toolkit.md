---
category: Substrate Toolkit
includes_base_categories: true
base_categories:
- basics
- reference
word_count: 79586
token_estimate: 167109
page_count: 37
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:91934dfc9078ca13dcb4501625ff2ac911410e20485938662714e79fba750f0a
---

# Begin New Bundle: Substrate Toolkit
...
Page Title: How to use the Polkadot.js API

- Resolved Markdown: https://docs.moonbeam.network/builders/substrate/libraries/polkadot-js-api.md
- Canonical (HTML): https://docs.moonbeam.network/builders/substrate/libraries/polkadot-js-api/
- Summary: Learn how to use the Polkadot.js API to interact with a Moonbeam node to get chain data and send transactions (extrinsics) via the Substrate side of Moonbeam.
- Word Count: 4051; Token Estimate: 7372
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ad8e26b744c63223e7dd8823441c57e69afe3afd6b68b22c5333d243b058f5e6

# Polkadot.js API Library

## Introduction {: #introduction }

[Polkadot.js](https://wiki.polkadot.com/general/polkadotjs/) is a collection of tools that allow you to interact with Polkadot and its parachains, such as Moonbeam. The [Polkadot.js API](https://polkadot.js.org/docs/api/) is one component of Polkadot.js and is a library that allows application developers to query a Moonbeam node and interact with the node's Substrate interfaces using JavaScript, enabling you to read and write data to the network.
...
Similar to [Ethereum API libraries](/moonbeam-mkdocs/builders/ethereum/libraries/), you must first instantiate an API instance of the Polkadot.js API. Create the `WsProvider` using the WebSocket endpoint of the Moonbeam network you wish to interact with.
...
The Dry Run API is an easy and convenient way to test the integrity of a call without incurring any transaction fees. The Dry Run API can be accessed from the [Runtime Calls](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbeam.network#/runtime) tab of the **Developer** section of Polkadot.js Apps. While primarily intended for the [testing of XCM messages](/moonbeam-mkdocs/builders/interoperability/xcm/send-execute-xcm/#test-an-xcm-message-with-the-dry-run-api), the Dry Run API can be used to test any arbitrary call.
...
Note that the `signAndSend` function can also accept optional parameters, such as the `nonce`. For example, `signAndSend(alice, { nonce: aliceNonce })`. You can use the [sample code from the State Queries](/moonbeam-mkdocs/builders/substrate/libraries/polkadot-js-api/#state-queries) section to retrieve the correct nonce, including transactions in the mempool.
...
The `paymentInfo` function returns weight information in terms of `refTime` and `proofSize`, which can be used to determine the transaction fee. This is extremely helpful when crafting [remote execution calls via XCM](/moonbeam-mkdocs/builders/interoperability/xcm/remote-execution/).
...
The Transfer API page includes an [example code snippet](/moonbeam-mkdocs/learn/core-concepts/transfers-api/#monitor-all-balance-transfers-with-the-substrate-api) for subscribing to new finalized block headers, and retrieving all `balance.Transfer` events.
...
The [Consensus and Finality page](/moonbeam-mkdocs/learn/core-concepts/consensus-finality/) has sample code for using the exposed custom and Substrate RPC calls to check the finality of a given transaction.
...
The following example computes the deterministic transaction hash of a raw Ethereum legacy transaction by first computing its RLP ([Recursive Length Prefix](https://ethereum.org/developers/docs/data-structures-and-encoding/rlp/)) encoding, then hashing the result with keccak256.
...
Page Title: How to use the Python Substrate Interface

- Resolved Markdown: https://docs.moonbeam.network/builders/substrate/libraries/py-substrate-interface.md
- Canonical (HTML): https://docs.moonbeam.network/builders/substrate/libraries/py-substrate-interface/
- Summary: Learn the basics of how to use the Python Substrate Interface library to query chain data, send transactions, and more on Moonbeam networks.
- Word Count: 2115; Token Estimate: 3455
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:6434c7974d4a7b7d86c38cac6af95858e30de0d94ba23bbffa88d15c7cf6ad53
...
Page Title: Using Substrate API Sidecar with Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/builders/substrate/libraries/sidecar.md
- Canonical (HTML): https://docs.moonbeam.network/builders/substrate/libraries/sidecar/
- Summary: Learn how to use Sidecar, a Substrate-based REST service, with Moonbeam-based networks to access blocks, account balances, compute gas used, and more.
- Word Count: 2304; Token Estimate: 4607
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:284796d0d1755373ab63f4a4980aa372591e0d28f44c0c8ed3219d79a94f2ecb
...
```bash
npm install @substrate/api-sidecar@20.12.0
```
...
Substrate API Sidecar v20.12.0 is the current stable version that has been tested to work with Moonbeam networks. You can verify the installation was successful by typing from the installation directory root:
...
Please reference the [Public Endpoints](/moonbeam-mkdocs/builders/get-started/endpoints/) page for a full list of Moonbeam network endpoints.
...
First, ensure that you installed [Parity's `generate-types-bundle` package](https://github.com/paritytech/generate-type-bundle):
...
For more information on the new [EIP1559](https://eips.ethereum.org/EIPS/eip-1559) and [EIP2930](https://eips.ethereum.org/EIPS/eip-2930) transaction types and what each field means, please refer to the respective official Ethereum proposal specs.
...
Moonbeam ERC-20 token transfers will emit the [`Transfer`](https://eips.ethereum.org/EIPS/eip-20) event which can be decoded as the following:
...
The [Transfers API page](/moonbeam-mkdocs/learn/core-concepts/transfers-api/#using-substrate-api-sidecar) has a code snippet demonstrating how to use Substrate API Sidecar to retrieve and decode native token transfers sent with both Substrate and Ethereum APIs on Moonbeam networks. You can reference that as a starting point to build out backends that utilize Sidecar to listen to transfers on Moonbeam networks.

## Calculating Transaction Fees {: #calculating-transaction-fees }

For more detailed information and sample code on how to calculate the transaction fees of Moonbeam transactions using Substrate Sidecar API, please check the [Calculating Transaction Fees on Moonbeam](/moonbeam-mkdocs/learn/core-concepts/tx-fees/) page.
