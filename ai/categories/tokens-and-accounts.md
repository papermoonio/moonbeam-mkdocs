---
category: Tokens and Accounts
includes_base_categories: true
base_categories:
- basics
- reference
word_count: 93199
token_estimate: 184518
page_count: 44
build_timestamp: '2026-06-20T05:24:27.156643+00:00'
version_hash: sha256:146cbaa721833ff4f86a8b551f9d9fae721f975327da7659be9849eb2c06ee44
---

# Begin New Bundle: Tokens and Accounts
Includes shared base categories: basics, reference


---

Page Title: Account Balances

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/balances.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/balances/
- Summary: A description of the main differences that Ethereum developers need to understand in terms of account balances on Moonbeam and how they differ from Ethereum.
- Word Count: 1236; Token Estimate: 1799
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:f29264b5ee792e6fc4969cb22cc7488612d533c0da6e115bd50d251020a17ee5
...
![Ethereum balances diagram](/moonbeam-mkdocs/images/learn/core-concepts/balances/balances-1.webp)
...
As with Ethereum, there are two main types of accounts: user-owned and contract owned. However, on Moonbeam, within both account types, there are also [proxy accounts](https://wiki.polkadot.com/learn/learn-proxies/), which can perform a limited number of actions on behalf of another account. In terms of balances, all of Moonbeam account types have five (5) different [balance types](https://wiki.polkadot.com/learn/learn-account-balances/):
...
![Moonbeam balances diagram](/moonbeam-mkdocs/images/learn/core-concepts/balances/balances-2.webp)
...
You can check on your balances, including your free (or transferable) and reserved balances (if exists), using the [Polkadot.js API](/moonbeam-mkdocs/builders/substrate/libraries/polkadot-js-api/).
...
Page Title: Add Token Information on Moonscan

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/token-profile.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/token-profile/
- Summary: Add token information and create a token profile on Moonscan for ERC-20, ERC-721, and ERC-1155 tokens deployed to Moonbeam-based networks.
- Word Count: 1280; Token Estimate: 1931
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:049d5c084b06dc129af79c0681b9ce65a935610b972e0546e2b65634842294b5

# Add Token Information on Moonscan

## Introduction {: #introduction }

This tutorial will guide you through the process of adding a profile for your ERC-20, ERC-721, or ERC-1155 tokens to [Moonscan](https://moonscan.io).
...
![Example token profile](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-1.webp)
...
- A [Moonscan Account](https://moonscan.io/register)
...
![Update token](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-2.webp)
...
You can verify your contract source code a couple of ways. You can directly verify it from Moonscan, or if you developed the contract with Hardhat or Foundry, you can also use their corresponding [Etherscan integrations](/moonbeam-mkdocs/builders/ethereum/verify-contracts/etherscan-plugins/).

To verify your contract source code directly from Moonscan, you can click on the **tool** link.

![Token update application form](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-3.webp)
...
![Verify & publish contract - page 1](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-4.webp)
...
![Verify & publish contract - page 2](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-5.webp)
...
![Token update application form](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-6.webp)
...
![Verify address ownership](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-7.webp)
...
![Manually verify address ownership](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-8.webp)
...
![Connect MetaMask account](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-9.webp)
...
![Sign message on MetaMask to verify address ownership](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-10.webp)
...
![Verify address ownership submission](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-11.webp)
...
![Create token profile](/moonbeam-mkdocs/images/builders/get-started/token-profile/profile-12.webp)
...
- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/explorers.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/explorers/
- Summary: An overview of the currently available block explorers that may be used to navigate the Substrate and Ethereum layers of Moonbeam.
- Word Count: 963; Token Estimate: 2508
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:89e63a3ec3f4fa936ded91d7d8d673b4121793501ea811acbe4cf58f2c8b7f3e
...
[Moonscan](https://moonscan.io) is the primary Ethereum API block explorer for Moonbeam-based networks. Built by the Etherscan team, Moonscan provides a powerful, intuitive, and feature-rich experience. In addition to its comprehensive transaction and block data, Moonscan provides a number of [statistics and charts](https://moonbeam.moonscan.io/charts), such as average gas price, daily transactions, and block size charts.

Other Moonscan features include:

 - [Collator leaderboard](https://moonbeam.moonscan.io/collators) ranking collators by performance
 - [Contract source code verification](/moonbeam-mkdocs/builders/ethereum/verify-contracts/block-explorers/), accessible both via a web interface and an API
 - Ability to read and write state data of verified smart contracts
 - [Token approvals](https://moonscan.io/tokenapprovalchecker) where you can view and revoke any of your prior token approvals
 - [Adding token information](/moonbeam-mkdocs/builders/get-started/token-profile/) and creating a profile for ERC-20s, ERC-721s, and ERC-1155s deployed to Moonbeam-based networks. The profile can include links to your project, social media, price data, and other information pertaining to your token

![Moonbeam Moonscan](/moonbeam-mkdocs/images/builders/get-started/explorers/explorers-1.webp)

### Expedition {: #expedition }

A Moonbeam-themed version of the [Expedition](https://github.com/xops/expedition) explorer can be found in [this link](https://moonbeam-explorer.netlify.app). It is a basic JSON-RPC based explorer.
...
![Expedition Explorer](/moonbeam-mkdocs/images/builders/get-started/explorers/explorers-2.webp)

## Substrate API {: #substrate-api }

### Subscan {: #subscan }

[Subscan](https://moonbeam.subscan.io) is the primary Substrate API block explorer for Moonbeam-based networks. Subscan is capable of parsing standard or custom modules. For example, this is useful to display information regarding the Staking, Governance, and EVM pallets (or modules). The code is all open-source and can be found in the [Subscan Essentials GitHub repo](https://github.com/subscan-explorer/subscan-essentials).

![Subscan Moonbeam](/moonbeam-mkdocs/images/builders/get-started/explorers/explorers-3.webp)

### Polkadot.js {: #polkadotjs }

While not a full-featured block explorer, Polkadot.js Apps is a convenient option especially for users running local development nodes to view events and query transaction hashes. Polkadot.js Apps uses the WebSocket endpoint to interact with the Network. You can easily connect to [Moonbeam](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbeam.network#/explorer), [Moonriver](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonriver.moonbeam.network#/explorer), or [Moonbase Alpha](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/explorer).

![Polkadot.js Moonbeam](/moonbeam-mkdocs/images/builders/get-started/explorers/explorers-4.webp)

To connect it to a Moonbeam development node, you can follow the steps in the [Connecting Polkadot.js Apps to a Local Moonbeam Node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/#connecting-polkadot-js-apps-to-a-local-moonbeam-node) section of the [Getting Started with a Moonbeam Development Node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/) guide. The default port for this is `9944`.

![Polkadot.js Local Node](/moonbeam-mkdocs/images/builders/get-started/explorers/explorers-5.webp)


---

Page Title: Calculating Transaction Fees

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/tx-fees.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/tx-fees/
- Summary: Learn about the transaction fee model used in Moonbeam and the differences compared to Ethereum that developers should be aware of.
- Word Count: 3401; Token Estimate: 6238
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:19e3658c4a10f642153d84a7458b73728d1065bc365b7e0b11283ab9efbcf6a3

# Calculating Transaction Fees on Moonbeam

## Introduction {: #introduction }

Similar to [the Ethereum and Substrate APIs for sending transfers](/moonbeam-mkdocs/learn/core-concepts/transfers-api/) on Moonbeam, the Substrate and EVM layers on Moonbeam also have distinct transaction fee models that developers should be aware of when they need to calculate and keep track of transaction fees for their transactions.
...
There are some key differences between the transaction fee model on Moonbeam and the one on Ethereum that developers should be mindful of when developing on Moonbeam:
  ...
  - Moonbeam has implemented a new mechanism defined in [MBIP-5](https://github.com/moonbeam-foundation/moonbeam/blob/master/MBIPS/MBIP-5.md) that limits block storage and increases gas usage for transactions that result in an increase in storage
...
The `BaseFee` is the minimum amount charged to send a transaction and is a value set by the network itself. It was introduced in [EIP-1559](https://eips.ethereum.org/EIPS/eip-1559). Moonbeam has its own [dynamic fee mechanism](https://forum.moonbeam.network/t/proposal-dynamic-fee-mechanism-for-moonbeam-and-moonriver/241) for calculating the base fee, which is adjusted based on block congestion. As of runtime 2300, the dynamic fee mechanism has been rolled out to all of the Moonbeam-based networks.
...
The pallets endpoints for Sidecar returns data relevant to a pallet, such as data in a pallet's storage. You can read more about the pallets endpoint in the [official Sidecar documentation](https://paritytech.github.io/substrate-api-sidecar/dist/#operations-tag-pallets). The data at hand that's required from storage is the `nextFeeMultiplier`, which can be found in the `transaction-payment` pallet. The stored `nextFeeMultiplier` value can be read directly from the Sidecar storage schema. Read as a JSON object, the relevant nesting structure is as follows:
...
The values of `GasPrice`, `MaxFeePerGas` and `MaxPriorityFeePerGas` for the applicable transaction types can be read from the block JSON object according to the structure described in [the Sidecar API page](/moonbeam-mkdocs/builders/substrate/libraries/sidecar/#evm-fields-mapping-in-block-json-object).
...
Moonbeam networks implement the [`eth_feeHistory`](https://www.alchemy.com/docs/chains/ethereum/ethereum-api-endpoints/eth-fee-history) JSON-RPC endpoint as a part of the support for EIP-1559.
...
async function main()
        ...
        // transaction fee
        if (extrinsic.args.transaction.legacy) else if (extrinsic.args.transaction.eip1559) else if (extrinsic.args.transaction.eip2930)
...
This section of the guide assumes you are interacting with Moonbeam blocks via [the Substrate API Sidecar](/moonbeam-mkdocs/builders/substrate/libraries/sidecar/) service. There are other ways of interacting with Moonbeam blocks, such as using [the Polkadot.js API library](/moonbeam-mkdocs/builders/substrate/libraries/polkadot-js-api/). The logic is identical once the blocks are retrieved.
...
**Note that the information in this section assumes you are running version 20.12.0 of the Substrate Sidecar REST API.**
...
The block endpoints will return data relevant to one or more blocks. You can read more about the block endpoints on the [official Sidecar documentation](https://paritytech.github.io/substrate-api-sidecar/dist/#operations-tag-blocks). Read as a JSON object, the relevant nesting structure is as follows:  
...
Page Title: Canonical Contract Addresses on Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/canonical-contracts.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/canonical-contracts/
- Summary: Overview of the canonical contracts available on Moonbeam, Moonriver, & Moonbase Alpha, including common-good contracts and precompiles.
- Word Count: 1971; Token Estimate: 6986
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:4e5359d541e93f2cc3d2497bc88e6e5fa2bee8dcf3a310412f5beb0281535a07
...
Page Title: Consensus & Finality

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/consensus-finality.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/consensus-finality/
- Summary: The main differences that Ethereum developers should understand in terms of consensus and finality on Moonbeam and how it differs from Ethereum.
- Word Count: 3260; Token Estimate: 5162
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:28483b9cdbe7bf276424d92f8ad824320068cee69241c63df179192a654e931a
...
Page Title: Cross-Consensus Messaging (XCM)

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/overview.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/overview/
- Summary: An overview of how cross-consensus messaging (XCM) works and how developers can leverage Polkadot/Kusama XCM to gain access to new assets.
- Word Count: 2687; Token Estimate: 3758
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:f263b87b374121c41d8039cfb4beddd60f1def6a27ce3b66eff3ec9c07766388
...
Page Title: Ethereum App

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/ledger.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/ledger/
- Summary: This guide walks you through how to use your Ledger hardware wallet to sign transactions in Moonbeam-based networks using the Ethereum app on Ledger Live.
- Word Count: 2818; Token Estimate: 3867
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ff2973620a6454ce80526c0c53ef04aa6cdd7f1be191b40a8cdb43280c52bc3b
...
- Resolved Markdown: https://docs.moonbeam.network/learn/features/eth-compatibility.md
- Canonical (HTML): https://docs.moonbeam.network/learn/features/eth-compatibility/
- Summary: Transitioning from Ethereum to Moonbeam? Here's a brief overview of the key components and key differences of Moonbeam's Ethereum compatibility.
- Word Count: 1116; Token Estimate: 1609
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:6cb796aa6c0bb63f1a1b83c41f8dcfb5923364324011eb9979022b719d1db1ea
...
Page Title: Fiat On-Ramps Available for Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/on-ramps.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/on-ramps/
- Summary: This guide introduces on-ramps for Moonbeam, including Transak and Onramp, and provides an overview of the process to acquire GLMR from each.
- Word Count: 707; Token Estimate: 856
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:3a9abb4c75822147f70d67d438b1cafb2903303e107d8768a0ff9c8288b105d5

# Fiat On-Ramp Services to Acquire GLMR for Moonbeam

## Introduction

Interacting with dApps or deploying smart contracts on Moonbeam requires users to hold GLMR tokens, which are used to pay for network transaction fees (gas). To help users acquire GLMR, there are several reliable on-ramp services available to convert local currency (fiat) into GLMR. This guide covers two popular options - [Transak](https://transak.com/buy/glmr) and [Onramp](https://onramp.money/) - each offering different payment methods and features to suit individual needs. Supporting bank transfers, credit cards, and mobile payment solutions, these platforms provide secure and regulated ways to acquire GLMR tokens. 

You can find a current list of supported on-ramps on the [Moonbeam dApp](https://apps.moonbeam.network/moonbeam). Please be aware that the availability of these services may vary by jurisdiction. For more information, please visit the website of the respective on-ramp. 

## Transak

Using Transak is a straightforward way to purchase GLMR tokens for the Moonbeam network. The process begins at [Transak](https://transak.com/buy/glmr) with selecting GLMR as the desired cryptocurrency. Users select their local currency and purchase amount, then review the associated fees and processing time details. The next step requires entering the destination Moonbeam wallet address. For bank transfers and other fiat payment methods, a one-time KYC verification process must be completed by providing valid identification documents. After payment completion through the selected method (bank transfer, credit card, or other supported options), Transak processes the transaction and sends the GLMR tokens directly to the specified wallet address. Delivery time varies depending on the payment method selected, ranging from near-instant for card payments to up to 2 business days for bank transfers.

## Onramp

[Onramp](https://onramp.money/) offers a seamless fiat-to-crypto gateway for purchasing GLMR tokens, supporting over 400 different cryptocurrencies through their platform. The process begins with a straightforward phone-based OTP login system for verification. After login, the platform displays transaction details, including the GLMR amount and current market rates, for confirmation. Based on geographical location, Onramp displays relevant bank account details and available payment methods. Once payment is completed through the selected method, Onramp handles all aspects of the conversion - from payment processing to regulatory compliance and wallet management. Upon confirmation of the deposit, the platform automatically purchases GLMR at the current market price and then initiates an automatic withdrawal to the specified Moonbeam wallet address. Additional KYC verification may be required for larger transactions, but the platform manages all compliance requirements internally to ensure a smooth experience.
...
Page Title: Get Started with Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/networks/moonbeam.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/networks/moonbeam/
- Summary: Learn how to connect to Moonbeam via RPC and WSS endpoints, how to connect MetaMask to Moonbeam, and about the available Moonbeam block explorers.
- Word Count: 515; Token Estimate: 1289
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:4e7af2709d28065781d1440d94d3b544478eb64f3dead122c919b40cac13944c
...
- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/glossary.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/glossary/
- Summary: We've compiled a glossary of terms related to Polkadot that'll make it easier to learn more about the ecosystem.
- Word Count: 684; Token Estimate: 910
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:024dda17e727a8bc113d577768ba42cd93161c37e459ac1ec45650d0927df3a6
...
Moonbeam token holders who stake tokens, vouching for specific collator candidates on the parachain. Any user that holds a minimum amount of tokens as [free balance](https://wiki.polkadot.com/learn/learn-account-balances/) can become a delegator by staking their tokens.
...
A [smart contract](https://en.wikipedia.org/wiki/Smart_contract) is a computer program or a transaction protocol that is intended to automatically execute, control, or document legally relevant events and actions according to the terms of a contract or an agreement. Smart contracts intend to reduce the need for trusted intermediators, arbitrations, and enforcement costs, as well as reduce fraud losses and malicious and accidental exceptions.

### Substrate {: #substrate }

A Rust-based blockchain development framework created by Parity Technologies based on their experience implementing multiple blockchain clients. Substrate comes with many modules and functionalities that are needed when building a blockchain, including P2P networking, consensus mechanisms, staking, cryptocurrency, on-chain governance modules, and more. It reduces the time and engineering effort required to implement a blockchain. Substrate is part of the [Polkadot SDK](https://wiki.polkadot.com/general/glossary/#polkadot-sdk).
...
- Resolved Markdown: https://docs.moonbeam.network/learn/features/governance.md
- Canonical (HTML): https://docs.moonbeam.network/learn/features/governance/
- Summary: As a Polkadot parachain, Moonbeam uses an on-chain governance system, allowing for a stake-weighted vote on public referenda.
- Word Count: 4140; Token Estimate: 13238
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:8fd064f22cca3717929adae08e047165fef231f337fe7c0c1f64306efcdf3983
...
Page Title: Historical Updates

- Resolved Markdown: https://docs.moonbeam.network/builders/build/historical-updates.md
- Canonical (HTML): https://docs.moonbeam.network/builders/build/historical-updates/
- Summary: An overview of the historical updates made on Moonbeam and Moonriver, such as migrations and bug fixes applied to the Moonbeam source code.
- Word Count: 6177; Token Estimate: 12780
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:5e29beb1fdb9217353afef60c661b6873d7ec2b01dcd2e9d92eba980fd8a9903
...
For more information, you can review the [relative Frontier PR on GitHub](https://github.com/polkadot-evm/frontier/pull/465).

---

#### Ethereum Fees Weren't Sent to Treasury {: #ethereum-fees-to-treasury }

The Moonbeam transaction fee model before Runtime 3401 and the passage of [MB101](https://forum.moonbeam.network/t/proposal-mb101-burn-100-of-transaction-fees-on-moonbeam/2022) mandated a 20% allocation of fees sent to the on-chain Treasury and 80% burned as a deflationary force. However, before runtime 800, Ethereum transactions did not correctly allocate 20% of the transaction fees to the on-chain Treasury.
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/732).
...
For more information, you can review the [relative Frontier PR](https://github.com/polkadot-evm/frontier/pull/509) and the associated [Substrate PR on GitHub](https://github.com/paritytech/substrate/issues/10117).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1291).
...
|    Network     |                                                              Block Range                                                              |
|:--------------:|:-------------------------------------------------------------------------------------------------------------------------------------:|
|    Moonbeam    | [1041355 - 1041358 and 1100752](https://moonbeam.subscan.io/extrinsic?module=evm&call=hotfix_inc_account_sufficients) |
|   Moonriver    |      [1835760 - 1835769](https://moonriver.subscan.io/extrinsic?module=evm&call=hotfix_inc_account_sufficients)       |
| Moonbase Alpha |  [2097782 - 2097974](https://moonbase.subscan.io/extrinsic?address=&module=evm&call=hotfix_inc_account_sufficients)   |
...
For more information, you can review the [relative Frontier PR on GitHub](https://github.com/moonbeam-foundation/frontier/pull/46/files).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1451).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2291).
...
You can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1719) for more information.
...
For more information on the root fix, you can review the [relative Frontier PR on GitHub](https://github.com/polkadot-evm/frontier/pull/570/). To take a look at the correction of the parent hash, check out the corresponding [Moonbeam PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2524).
...
For more information, you can review the [relative Frontier PR](https://github.com/moonbeam-foundation/frontier/pull/45).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1528).

---

#### Incorrect State Root Hash {: #incorrect-state-root-hash }

The state root hash was miscalculated for non-legacy transactions as the transaction-type byte was not considered. With the support of [EIP-2930](https://eips.ethereum.org/EIPS/eip-2930) and [EIP-1559](https://eips.ethereum.org/EIPS/eip-1559), the transaction types introduced are `0x01` (1) and `0x02` (2), respectively. These transaction types were omitted from the state root hash calculation.
...
For more information, you can review the [relative Frontier PR](https://github.com/moonbeam-foundation/frontier/pull/86) and [Moonbeam PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1678/files).
...
For more information, you can review the [relative Frontier PR on GitHub](https://github.com/polkadot-evm/frontier/pull/638).
...
You can review the [relative Frontier PR on GitHub](https://github.com/polkadot-evm/frontier/pull/935) for more information.
...
You can review the [relative Frontier PR](https://github.com/polkadot-evm/frontier/pull/1280) and [Moonbeam PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2610) for more information.
...
Since the real `ref_time` in production runtimes is smaller, this could cause the block weight limits to be reached when replaying a block in an EVM-tracing runtime, resulting in skipped transaction traces. This was observed in Moonbeam block [9770044](https://moonbeam.subscan.io/block/9770044).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/3210).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/3128).
---
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/679).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1407).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1525).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1744).
...
A migration was applied, which moved preimages stored in the democracy pallet to a new preimage pallet. This migration on Moonbeam was required as a result of an [upstream change to Polkadot](https://github.com/paritytech/substrate/pull/11649/).

There was one preimage that was affected in Moonbeam, which was dropped from the scheduler queue and never executed: `0x14262a42aa6ccb3cae0a169b939ca5b185bc317bb7c449ca1741a0600008d306`. This preimage was [manually removed](https://moonbeam.subscan.io/extrinsic/2693398-8) by the account that initially submitted the preimage.
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1962).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2643).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2711).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2685).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2526).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/505).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/502).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/610).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/970).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/810).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1096).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1117).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1408).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1604).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1878).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2690).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2976).
...
This stemmed from an upstream change to the [Substrate](https://github.com/paritytech/substrate/pull/12788) repository.
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2134).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1114).

---

#### Add Support for Kusama Asset Hub (Statemine) Prefix Breaking Change {: #add-support-statemine-prefix }

The following three migrations were added to the asset manager pallet to avoid issues with Kusama Asset Hub's (previously referred to as Statemine) [breaking change to the way it represents assets](https://github.com/paritytech/cumulus/pull/831) and possible future breaking changes:
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1159).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1118).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2145).
...
For more information, you can review the [relative PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/2634).
...
For more information, you can review the relative PRs on GitHub: [2869](https://github.com/moonbeam-foundation/moonbeam/pull/2869) and [3020](https://github.com/moonbeam-foundation/moonbeam/pull/3020).
...
For more information, you can review the [relative Nimbus PR](https://github.com/moonbeam-foundation/nimbus/pull/45) and [Moonbeam PR on GitHub](https://github.com/moonbeam-foundation/moonbeam/pull/1400).


---

Page Title: How to Connect & Use Trezor

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/trezor.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/trezor/
- Summary: Learn how to import your Trezor hardware wallet to MetaMask and how to use your Trezor to sign transactions on Moonbeam.
- Word Count: 1568; Token Estimate: 2148
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:5c774663b0d004cc6c570ff9f3ef0fd4788282c29a3cdf8b72a1a28cc5c597c7
...
![MetaMask Select Trezor Hardware Wallet](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-2.webp)
...
![Trezor Hardware Wallet Connect Pair Device](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-3.webp)
...
![Trezor Hardware Wallet Connect Wizard Select and Connect Device](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-4.webp)
...
![Trezor Hardware Wallet Connect Wizard Allow Read Public Keys](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-5.webp)
...
![Trezor Hardware Wallet Connect Wizard Allow Export and Passphrase](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-6.webp)
...
![Trezor Select Ethereum Accounts to Import](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-7.webp)
...
![MetaMask Successfully Imported Trezor Account](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-8.webp)
...
First, make sure your Trezor account is [funded with DEV tokens](/moonbeam-mkdocs/builders/get-started/networks/moonbase/#get-tokens). Next, click on the **Send** button.

![MetaMask Trezor Account Funded](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-9.webp)
...
![Trezor Hardware Wallet Allow Read Public Keys and Signing](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-10.webp)
...
![Trezor Hardware Wallet Sign Transaction](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-11.webp)
...
![MetaMask Trezor Transaction Wizard](/moonbeam-mkdocs/images/tokens/connect/trezor/trezor-12.webp)
...
Page Title: How to Connect MetaMask

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/metamask.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/metamask/
- Summary: This guide walks you through how to connect MetaMask, a browser-based Ethereum wallet, to Moonbeam-based networks and how to transfer funds.
- Word Count: 2048; Token Estimate: 3727
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:cf17c90cf3ee8ba49da8bd5afe13c02f458a8808c12d48a50adb0bbbc1277318
...
Page Title: How to Connect SubWallet to Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/subwallet.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/subwallet/
- Summary: This guide walks you through how to connect SubWallet, a comprehensive Polkadot, Substrate, and Ethereum wallet, to Moonbeam.
- Word Count: 2673; Token Estimate: 3804
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:349af1220e8ec863e9597b2460bb53771725075242b08d00b22dadf26a4ec347

# Interacting with Moonbeam Using SubWallet

## Introduction {: #introduction }

Developers and users of Moonbeam have a variety of options when it comes to wallets. Thanks to Moonbeam's seamless Ethereum compatibility, Moonbeam supports a great variety of popular wallets, including [SubWallet](https://www.subwallet.app).

SubWallet is a comprehensive Web3 wallet that natively supports Substrate and Ethereum accounts. Although Moonbeam is a Substrate-based blockchain, it has a [unified account system](/moonbeam-mkdocs/learn/core-concepts/unified-accounts/) that replaces the default Substrate-style accounts and keys with Ethereum-style accounts and keys. Since SubWallet supports Ethereum-style accounts, you can interact with your Moonbeam account using SubWallet.
...
You can get started by heading to [SubWallet's download page](https://www.subwallet.app/download) and downloading SubWallet for the platform of your choice.

If you choose to use the web-accessible dashboard, you won't need to download anything. You can access the dashboard at [web.subwallet.app](https://web.subwallet.app/welcome).
...
![The main screen of the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-1.webp)
...
![The create a password screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-2.webp)
...
![Back up your seed phrase on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-3.webp)
...
![The main screen of the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-4.webp)
...
![Select the account type to import on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-6.webp)
...
![The create a password screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-7.webp)
...
![View account details and create a new account, import one, or attach one.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-8.webp)
...
If you're attaching an account, you can find out step-by-step instructions on [SubWallet's Account management documentation](https://docs.subwallet.app/main/extension-user-guide/account-management).
...
![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-9.webp)
...
![The customize asset display screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-10.webp)

If you're trying to connect to a [local Moonbeam development node](/moonbeam-mkdocs/builders/get-started/networks/moonbeam-dev/), you can select the hamburger menu from the top left corner, which will take you to the settings page.

![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-11.webp)

From the settings menu, click **Manage networks**.

![The settings screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-12.webp)

Click the **+** icon in the top right corner and enter in the [network configurations](/moonbeam-mkdocs/builders/get-started/quick-start/#network-configurations). You can also manage and connect to other networks from this menu.

![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-13.webp)

By default, all balances are hidden in SubWallet, but if you press the **Show balance** icon, you can toggle balance visibility.

![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-14.webp)
...
![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-15.webp)
...
![Select an account to receive tokens on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-16.webp)

Next, you can search for and choose the token that you would like to receive. For this example, DEV is chosen.

![Search and choose desired token on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-17.webp)
...
![QR code and address to receive tokens on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-18.webp)
...
![The tokens screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-19.webp)
...
![The transfer screen on the SubWallet browser extension, where you can enter in the transaction details.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-20.webp)
...
![The transfer confirmation screen on the SubWallet browser extension.](/moonbeam-mkdocs/images/tokens/connect/subwallet/subwallet-21.webp)

After you send the transaction, you'll be able to review the transaction details.

And that's it! For more information on how to use SubWallet, please refer to [SubWallet's documentation](https://docs.subwallet.app/main).
...
Page Title: How to use Polkadot.js Apps

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/polkadotjs.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/polkadotjs/
- Summary: Follow this quick tutorial to learn how to use Moonbeam’s Ethereum-style H160 addresses and send transactions with Polkadot.js Apps.
- Word Count: 1387; Token Estimate: 2002
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:1fca6f81d5d6b372cbd6cdb9711c94ef21741d751219584b75a9c481e1b27fec
...
Page Title: List your Dapp on the Moonbeam DApp Directory

- Resolved Markdown: https://docs.moonbeam.network/learn/dapp-directory.md
- Canonical (HTML): https://docs.moonbeam.network/learn/dapp-directory/
- Summary: Follow this tutorial to learn how to list your Moonbeam or Moonriver project or update a current listing on the Moonbeam Foundation DApp Directory.
- Word Count: 11900; Token Estimate: 28377
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:4e64ab357176ea7ddefc85cf4a7c269ca20bd5eb892be5b7d8812d9e4aabb29a
...
Page Title: Managing an Identity

- Resolved Markdown: https://docs.moonbeam.network/tokens/manage/identity.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/manage/identity/
- Summary: Learn how to create and manage an on-chain identity, which includes personal information such as your name and social handles, on Moonbeam-based networks.
- Word Count: 3003; Token Estimate: 5592
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ba060991b666da74af135b337bc3d569ac06f474161737cdd24897b774d0c5d9
...
=== "Moonbeam"
    ...
    |:---------------------:|:-----------------------------------------------------------------------:|:-----------------------------------------------:|
    |     Basic deposit     |           The amount held on deposit for setting an identity            | 1.0258 GLMR |
    |     Field deposit     | The amount held on deposit per additional field for setting an identity | 0.0066 GLMR |
    | Max additional fields |     Maximum number of additional fields that may be stored in an ID     |   100   |

=== "Moonriver"
    |       Variable        |                               Definition                                |                      Value                       |
    |:---------------------:|:-----------------------------------------------------------------------:|:------------------------------------------------:|
    |     Basic deposit     |           The amount held on deposit for setting an identity            | 1.0258 MOVR |
    |     Field deposit     | The amount held on deposit per additional field for setting an identity | 0.0066 MOVR |
    | Max additional fields |     Maximum number of additional fields that may be stored in an ID     |   100   |

=== "Moonbase Alpha"
    |       Variable        |                               Definition                                |                     Value                      |
    |:---------------------:|:-----------------------------------------------------------------------:|:----------------------------------------------:|
    |     Basic deposit     |           The amount held on deposit for setting an identity            | 1.0258 DEV |
    |     Field deposit     | The amount held on deposit per additional field for setting an identity | 0.0066 DEV |
    | Max additional fields |     Maximum number of additional fields that may be stored in an ID     |  100   |
...
- To connect to the [Moonbase Alpha TestNet](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network) on the Polkadot.js Apps explorer. You can also follow along and adapt the instructions for [Moonbeam](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbeam.network) or [Moonriver](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonriver.moonbeam.network).
- To [create or import an account](/moonbeam-mkdocs/tokens/connect/polkadotjs/#creating-or-importing-an-h160-account) into Polkadot.js Apps
...
To get started with setting an identity using the Accounts UI, head to the [Accounts tab](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/accounts) on the Polkadot.js Apps explorer.
...
![Starting account balances](/moonbeam-mkdocs/images/tokens/manage/identity/identity-1.webp)
...
![Set on-chain identity](/moonbeam-mkdocs/images/tokens/manage/identity/identity-2.webp)
...
![Set your identity](/moonbeam-mkdocs/images/tokens/manage/identity/identity-3.webp)
...
![Updated account balances](/moonbeam-mkdocs/images/tokens/manage/identity/identity-4.webp)
...
To clear your identity from the [Accounts tab](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/accounts) of the Polkadot.js Apps UI, you'll need to:

1. Click on the 3 vertical dots next to the account you would like to add identity information for
2. A menu will pop up. Click **Set on-chain identity**

![Set on-chain identity](/moonbeam-mkdocs/images/tokens/manage/identity/identity-5.webp)

The identity menu will pop-up with your information already filled out. You'll need to click **Clear Identity**.

![Clear identity](/moonbeam-mkdocs/images/tokens/manage/identity/identity-6.webp)
...
To register an identity using the extrinsics UI, navigate to the [Extrinsics page](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/extrinsics) on Polkadot.js Apps. Then, you'll need to:
...
![Set your identity using the Extrinsics UI](/moonbeam-mkdocs/images/tokens/manage/identity/identity-7.webp)
...
![Add custom fields](/moonbeam-mkdocs/images/tokens/manage/identity/identity-8.webp)
...
![Submit identity information](/moonbeam-mkdocs/images/tokens/manage/identity/identity-9.webp)
...
To verify the addition of your identity information, you can click on the **Developer** tab and then navigate to [Chain state](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/chainstate).
...
![Request identity information](/moonbeam-mkdocs/images/tokens/manage/identity/identity-10.webp)
...
To clear your identity from the [Extrinsics tab](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/extrinsics) of the Polkadot.js Apps UI, you'll need to:
...
![Clear an identity using the Extrinsics UI](/moonbeam-mkdocs/images/tokens/manage/identity/identity-11.webp)
...
=== "Moonbeam"
    ...
    |:---------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------:|:------------------------------------------:|:-----:|
    |        [Registrar #0](https://forum.moonbeam.network/t/referendum-73-identity-registrar-0/208)        | [Moonbeam Foundation](https://moonbeam.foundation) | 0xbE6E642b25Fa7925AFA1600C48Ab9aA3461DC7f1 |   0   |
    | [Registrar #1](https://forum.moonbeam.network/t/referendum-82-new-registrar-proposal-registrar-1/319) |         [Chevdor](https://www.chevdor.com)         | 0xeaB597B91b66d9C3EA5E3a39e22C524c287d61a5 |   1   |

=== "Moonriver"
    |                                                                Registrar                                                                 |                              Operator                               |                  Address                   | Index |
    |:----------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------:|:------------------------------------------:|:-----:|
    |         [Registrar #0](https://forum.moonbeam.network/t/referendum-120-identity-registrar-0/187)          | [Moonbeam Foundation](https://moonbeam.foundation) | 0x031590D13434CC554f7257A89B2E0B10d67CCCBa |   0   |
    | [Registrar #1](https://forum.moonbeam.network/t/referendum-125-new-registrar-proposal-registrar-1/303) |         [Chevdor](https://www.chevdor.com)         | 0x2d18250E01312A155E81381F938B8bA8bb4d97B3 |   1   |

=== "Moonbase Alpha"
    |                                      Registrar                                       |                      Operator                       |                  Address                   | Index |
    |:------------------------------------------------------------------------------------:|:---------------------------------------------------:|:------------------------------------------:|:-----:|
    | [Registrar #1](https://www.chevdor.com/post/2020/07/14/reg-updates) | [Chevdor](https://www.chevdor.com) | 0x4aD549e07E96BaD335A8b99C8fd32e95EE538904 |   1   |

You can get a complete list of the current registrars, including the fees that each registrar charges, by heading to [Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network), selecting the **Developer** tab, choosing **Chain State** from the dropdown, and taking the following steps:

1. Select the **identity** pallet
2. Choose the **registrars** extrinsic
3. Click the **+** button

![View registrar list](/moonbeam-mkdocs/images/tokens/manage/identity/identity-12.webp)
...
![Request identity judgement](/moonbeam-mkdocs/images/tokens/manage/identity/identity-13.webp)
...
![Identity verified](/moonbeam-mkdocs/images/tokens/manage/identity/identity-14.webp)
...
![Cancel judgement request](/moonbeam-mkdocs/images/tokens/manage/identity/identity-15.webp)
...
Page Title: Moonbase Alpha Get Started Guide

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/networks/moonbase.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/networks/moonbase/
- Summary: The Moonbeam TestNet, named Moonbase Alpha, is the easiest way to get started with a Polkadot environment. Follow this tutorial to connect to the TestNet.
- Word Count: 1126; Token Estimate: 2646
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ad7156ef1be674ea5bdf029fc4c69479dc28442adde49afdd54b43adfecc2711
...
Page Title: Moonbeam API Providers and Endpoints

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/endpoints.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/endpoints/
- Summary: Use one of the supported API providers to connect to a public endpoint or create custom JSON-RPC and WSS endpoints for Moonbeam-based networks.
- Word Count: 3167; Token Estimate: 6231
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:42240420a310fdf8a4df340185b18946ba2893808a43f4bc822ba52a621f14ab
...
[1RPC](https://www.1rpc.io) is a free and private RPC relay that protects user privacy by preventing data collection, user tracking, phishing attempts from other parties. It tunnels user requests via distributed relays to other RPC providers whilst preventing the tracking of user metadata such as IP address, device information and wallet linkability with secure enclave technology.
...
Head over to [1RPC](https://www.1rpc.io) official site to set it up!

![1RPC](/moonbeam-mkdocs/images/builders/get-started/endpoints/endpoints-1.webp)

### Chainstack {: #chainstack }

[Chainstack](https://chainstack.com/), the Web3 infrastructure provider, offers free and paid endpoints for Moonbeam. The free Developer plan starts with 3 million monthly requests and 25 requests per second (RPS). You can easily scale with the paid plans.

To start with a free Developer plan endpoint, sign up using an email or any social account, like GitHub or X (Twitter).

1. Visit [Chainstack](https://console.chainstack.com/)
2. Sign up
3. Deploy a Moonbeam node

![Chainstack](/moonbeam-mkdocs/images/builders/get-started/endpoints/endpoints-2.webp)

### dRPC NodeCloud {: #drpc }

dRPC.org offers public and paid [Moonbeam RPC](https://drpc.org/chainlist/moonbeam-mainnet-rpc) endpoints, providing an efficient, low-latency connection to blockchain nodes. The paid tiers include higher request limits, lower latency, and advanced analytics for optimized performance.
...
For 24/7 support, join dRPC's [Discord](https://drpc.org/discord).

### Dwellir {: #dwellir }

[Dwellir](https://www.dwellir.com) is a blockchain operation service that ensures global scalability, low latency, and a 99.99% uptime guarantee, providing fast and reliable node operations wherever your business stands. The public endpoint service is geographically distributed bare metal servers globally. As the service is public, there are no sign-up or API keys to manage.

To get started with a developer endpoint or dedicated node, you'll need to contact us:

1. Visit [Dwellir](https://www.dwellir.com/contact)
2. Submit your **email** and your node request

![Dwellir](/moonbeam-mkdocs/images/builders/get-started/endpoints/endpoints-3.webp)

### GetBlock {: #getblock }

[GetBlock](https://getblock.io) is a service that provides instant API access to Moonbeam and Moonriver and is available through shared and dedicated nodes. [Dedicated nodes](https://docs.getblock.io/getting-started/plans-and-limits/choosing-your-plan#dedicated-nodes) provide access to a private server with fast speeds and without rate limits. [Shared nodes](https://docs.getblock.io/getting-started/plans-and-limits/choosing-your-plan#shared-nodes) provide a free API/add-on based endpoint for you to get started quickly.

To get started with GetBlock, you can go to the [GetBlock registration page](https://account.getblock.io/sign-up) and sign up for a new account. Then, from your account **Dashboard**, you can view and manage your existing endpoints for multiple protocols, and also create new ones.
...
![GetBlock](/moonbeam-mkdocs/images/builders/get-started/endpoints/endpoints-4.webp)

### OnFinality {: #onfinality }

[OnFinality](https://onfinality.io/en) provides a free API key based endpoint for customers in place of a public endpoint. Additionally, OnFinality offers paid tiers of service that offer increased rate limits and higher performance than those offered by the free tier. You also receive more in depth analytics of the usage of your application.

To create a custom OnFinality endpoint, go to [OnFinality](https://onfinality.io/en) and sign up, or if you already have signed up you can go ahead and log in. From the OnFinality **Dashboard**, you can:

1. Click on **API Service**
2. Select the network from the dropdown
3. Your custom API endpoint will be generated automatically

![OnFinality](/moonbeam-mkdocs/images/builders/get-started/endpoints/endpoints-5.webp)

### UnitedBloc {: #unitedbloc }

[UnitedBloc](https://medium.com/unitedbloc/unitedbloc-rpc-c84972f69457) is a collective of community collators from both Moonbeam and Moonriver. To provide value for the community, they offer public RPC services for the Moonbeam, Moonriver, and Moonbase Alpha networks.
...
They also provide a [public Grafana dashboard](https://monitoring.unitedbloc.com:3030/public-dashboards/7444d2ab76ee45eda181618b0f0ecb98?orgId=1) with some cool metrics.

Check the [public endpoints section](#public-endpoints) to get the relevant URL. You can contact them via their [Telegram channel](https://t.me/+tRvy3z5-Kp1mMGMx), or read more about their initiative on their [blogpost page](https://medium.com/unitedbloc/unitedbloc-rpc-c84972f69457).

## Lazy Loading with RPC Endpoint Providers {: #lazy-loading-with-RPC-Endpoint-Providers }

Lazy loading lets a Moonbeam node operate while downloading network state in the background, eliminating the need to wait for full synchronization before use. To spin up a Moonbeam node with lazy loading, you'll need to either [download the Moonbeam release binary](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/#the-release-binary) or [compile the binary](/moonbeam-mkdocs/node-operators/networks/run-a-node/compile-binary/#compile-the-binary). You can activate lazy loading with the following flag:
...
??? note "Details about overriding account balances"
    ...
    Remember that the values are little endian encoded. To convert the hexadecimal little endian encoded values to decimal, you can use [Substrate Utilities converter](https://www.shawntabrizi.com/substrate-js-utilities/), using the **Balance to Hex (Little Endian)** converter.
...
In the example below, we override the token balance of the [Wormhole USDC Contract (`0x931715FEE2d06333043d11F658C8CE934aC61D0c`)](https://moonscan.io/address/0x931715FEE2d06333043d11F658C8CE934aC61D0c) for the account `0x3b939fead1557c741ff06492fd0127bd287a421e` to $5,000 USDC. Since Wormhole USDC uses 6 decimal places, $5,000 corresponds to `5000000000` in integer form, which is `0x12a05f200` in hexadecimal.
...
??? code "Example: Override WELL Token Balance"
    ...
    Because the [WELL token](https://moonbeam.moonscan.io/token/0x511ab53f793683763e5a8829738301368a2411e3) does not use a proxy implementation contract, the storage slot calculation differs. Instead of slot `5`, the balance mapping resides at slot `1`. You can determine the exact storage slot to override the WELL token balance for your own account using the following script:
...
[OnFinality](https://onfinality.io/en)'s Trace API can be used to quickly get started tracing and debugging transactions on Moonbeam and Moonriver. It is only available to users on their [Growth and Ultimate plans](https://onfinality.io/en/pricing).

To use the Trace API, you simply call the trace method of your choice from your [private RPC endpoint](#onfinality). For a list of the supported networks and trace methods, please check out [OnFinality's Trace API documentation](https://documentation.onfinality.io/support/trace-api#TraceAPI-SupportedNetworks).

Please note that if you are tracing historic blocks, it is recommended to use your own dedicated trace node to backfill any data, and then once you're caught up, you can switch to using the Trace API. You can check out the [How to Deploy a Trace Node for Moonbeam on OnFinality](https://onfinality.medium.com/how-to-deploy-a-trace-node-for-moonbeam-on-onfinality-85683181d290) post for more information on how to spin up your own dedicated trace node.


---

Page Title: Moonbeam Multisig Safe

- Resolved Markdown: https://docs.moonbeam.network/tokens/manage/multisig-safe.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/manage/multisig-safe/
- Summary: Learn how to use and manage funds with the Moonbeam Safe. Create a new multisig safe and receive and send tokens to the safe, as well as ERC-20s, on Moonbeam.
- Word Count: 4205; Token Estimate: 6121
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:0e40fd4e2aa0919eb13dfae58d48a00b4ab1fceaf1543e032a04c2e0431fb195
...
Later on in this guide, you will be learning how to send and receive ERC-20 tokens to and from the Safe. So you will need to have deployed some ERC-20 tokens and added them to your MetaMask account. To do so, you can check out the [Using Remix to Deploy to Moonbeam](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/) guide, in particular the [Deploying a Contract to Moonbeam](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/#deploying-a-contract-to-moonbeam-using-remix) and [Interact with a Moonbeam-based ERC-20](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/#interacting-with-a-moonbeam-based-erc-20-from-metamask) sections will show you how to deploy an ERC-20 token and import it into MetaMask.

### Deployed Smart Contract {: #deployed-smart-contract }

Towards the end of this guide, you will be learning how to interact with a smart contract using the Safe. So you will need to have a smart contract deployed to interact with. If you would like detailed instructions, you can refer to the [Deploying a Contract to Moonbeam using Remix](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/#deploying-a-contract-to-moonbeam) guide.
...
To get started creating a Safe, navigate to the [Moonbeam Safe](https://multisig.moonbeam.network/?chain=mbase). For the purpose of this guide, you'll create a Safe on Moonbase Alpha, but you can also adapt the instructions to create a Safe on [Moonbeam](https://multisig.moonbeam.network/?chain=mbeam) or [Moonriver](https://multisig.moonbeam.network/?chain=mriver). To switch networks, simply click the network dropdown in the top right hand corner of the page. 

### Connect MetaMask {: #connect-metamask }

Once on the [Moonbase Alpha](https://multisig.moonbeam.network/?chain=mbase) page, you can begin to create a Safe by first connecting your wallet:
...
![Connect Wallet to Moonbeam Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-1.webp)
...
![Connect MetaMask to Moonbase Alpha](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-2.webp)
...
![Create Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-3.webp)
...
![Submit Safe Name](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-4.webp)
...
![Enter Safe Owners](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-5.webp)
...
![Send Transaction to Create Multisig Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-6.webp)
...
![Safe Created Successfully](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-7.webp)
...
![Modify Safe Settings](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-8.webp)
...
![Receive Tokens to the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-9.webp)

A pop-up will appear with the address of the Safe. Copy the address and click **Done**. 

![Copy Safe Address](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-10.webp)
...
![Send DEV Tokens to the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-11.webp)
...
![Send Tokens from the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-12.webp)
...
![Send 1 DEV Token from the Safe to Bob](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-13.webp)
...
![Submit Transaction and Sign Message](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-14.webp)
...
![Transaction Needs Confirmations](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-15.webp)
...
![Submit Transaction Confirmation](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-16.webp)
...
![Successfully Executed Transaction](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-17.webp)
...
You'll need to get the Safe's address again, you can do so by clicking on the **Copy to clipboard** icon in the top left hand corner. Once you've got your Safe's address copied, open up MetaMask:
 ...
 4. Enter amount of MYTOKs to send. You should have minted 8M MYTOK tokens in the [Using Remix to Deploy to Moonbeam](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/) guide. So for this example, you can enter 1000 MYTOKs for the amount to send
 5. Click **Next**
 6. Review the transaction details and then click **Confirm** to send the transaction.

![Send ERC-20s to the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-18.webp)
...
![Send ERC-20s from the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-19.webp)
...
![Send ERC-20s to Charlie from the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-20.webp)
...
![Sign Message to Send ERC-20s to Charlie from the Safe](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-21.webp)
...
![Transaction Needs Confirmation](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-22.webp)
...
![Successfully Executed Transaction](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-23.webp)
...
![New Contract Interaction](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-24.webp)
...
![Create Contract Interaction](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-25.webp)
...
![Submit Contract Interaction](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-26.webp)
...
![Transaction Needs Confirmation](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-27.webp)
...
![Transaction History](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-28.webp)
...
![Contract Interaction Call Result](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-29.webp)
...
![Contract Interaction Call Result](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-30.webp)
...
![Contract Interaction Call Result](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-31.webp)
...
![Contract Interaction Call Result](/moonbeam-mkdocs/images/tokens/manage/multisig-safe/safe-32.webp)
...
Page Title: Moonbeam-specific RPC Methods

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/json-rpc/moonbeam-custom-api.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/json-rpc/moonbeam-custom-api/
- Summary: Discover Moonbeam's specialized API endpoints, featuring custom JSON-RPC methods designed exclusively for Moonbeam functionality.
- Word Count: 341; Token Estimate: 657
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:680c9a11dce105b16637f0da7076605bdf8c7b2fc07fcb34ffd14cb39f9aa601
...
Page Title: Moonriver Get Started Guide

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/networks/moonriver.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/networks/moonriver/
- Summary: Learn how to connect to Moonriver via RPC and WSS endpoints, how to connect MetaMask to Moonriver, and about the available Moonriver block explorers.
- Word Count: 498; Token Estimate: 1236
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:95ee64790a9b70ee7b7108cc681c7c9ca0cf5fbb429dec73c53966f1cb90fbd8
...
Page Title: Quickly Get Started

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/quick-start.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/quick-start/
- Summary: Everything you need to know to get started developing, deploying, and interacting with smart contracts on Moonbeam.
- Word Count: 992; Token Estimate: 4211
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:3805cc4dc3fd7f3cd296413ed78798c9d216bbfbe0166c34b7ba44d5c427298d
...
- Resolved Markdown: https://docs.moonbeam.network/learn/features/randomness.md
- Canonical (HTML): https://docs.moonbeam.network/learn/features/randomness/
- Summary: Learn about the sources of VRF randomness on Moonbeam, the request and fulfillment process, and some security considerations when using on-chain randomness.
- Word Count: 1657; Token Estimate: 2557
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:5cccb6bff951c1073c57cb185e2734aa7303c239dac41615dfb719842ad610c4
...
You can request local VRF randomness using the [`requestLocalVRFRandomWords` method](/moonbeam-mkdocs/builders/ethereum/precompiles/features/randomness/#:~:text=requestLocalVRFRandomWords) of the [Randomness Precompile](/moonbeam-mkdocs/builders/ethereum/precompiles/features/randomness/).
...
BABE epoch randomness is based on a hash of the VRF values from the blocks produced in the relay chain epoch before last. On Polkadot, an [epoch lasts for roughly 4 hours](https://wiki.polkadot.com/learn/learn-cryptography/#vrf), and on Kusama, an [epoch lasts for roughly 1 hour](https://wiki.polkadot.com/kusama/kusama-getting-started/#periods-of-common-actions-and-attributes). The hashing is completed on the relay chain, and as such, it is not possible for a collator on Moonbeam to influence the randomness value unless they are also a validator on the relay chain and were responsible for producing the last output included in an epoch.
...
You can request BABE epoch randomness using the [`requestRelayBabeEpochRandomWords` method](/moonbeam-mkdocs/builders/ethereum/precompiles/features/randomness/#:~:text=requestRelayBabeEpochRandomWords) of the [Randomness Precompile](/moonbeam-mkdocs/builders/ethereum/precompiles/features/randomness/). In order to generate unique randomness, a different salt must be provided to the `requestRelayBabeEpochRandomWords` function.
...
Page Title: Remote Execution Overview

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/remote-execution/overview.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/remote-execution/overview/
- Summary: Learn the basics of remote execution via XCM messages, which allow users to execute actions on other blockchains using accounts they control remotely via XCM.
- Word Count: 919; Token Estimate: 1344
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ae8aa736fa28cf8beda59e6d4a42d0c2af3e0b3889b2fdb2f390aedf8a72dc81
...
Page Title: Run a Collator Node

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/collators/overview.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/collators/overview/
- Summary: Instructions on how to dive in and become a collator in the Moonbeam Network once you are running a node.
- Word Count: 559; Token Estimate: 740
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:41830eff6a69596aef4eac22b88951c2f2954a31db0e882151e4baafac44342e
...
There are some [requirements](/moonbeam-mkdocs/node-operators/networks/collators/requirements/) that need to be considered prior to becoming a collator candidate including machine, bonding, account, and community requirements.
...
Users can spin up full nodes on Moonbeam, Moonriver, and Moonbase Alpha and activate the `collate` feature to participate in the ecosystem as collator candidates. To do this, you can checkout the [Run a Node](/moonbeam-mkdocs/node-operators/networks/run-a-node/) section of the documentation and spin up a node using either [Docker](/moonbeam-mkdocs/node-operators/networks/run-a-node/docker/) or [Systemd](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/).
...
Page Title: Run a Moonbeam Development Node

- Resolved Markdown: https://docs.moonbeam.network/builders/get-started/networks/moonbeam-dev.md
- Canonical (HTML): https://docs.moonbeam.network/builders/get-started/networks/moonbeam-dev/
- Summary: Follow this tutorial to learn how to spin up your first Moonbeam development node, how to configure it for development purposes, and connect to it.
- Word Count: 3923; Token Estimate: 6697
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:af73a148bc8059c440776c22e9b699ccf9fb200570486d2224d177fc5b248e18
...
Page Title: Run a Node

- Resolved Markdown: https://docs.moonbeam.network/node-operators/networks/run-a-node/overview.md
- Canonical (HTML): https://docs.moonbeam.network/node-operators/networks/run-a-node/overview/
- Summary: Learn about all of the necessary details to run a full parachain node for the Moonbeam Network to have your RPC endpoint or produce blocks.
- Word Count: 1423; Token Estimate: 2916
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:007285c169395e1ec467c4fe4835ee71bb2c2814f150682b0650a7227367a537
...
There are multiple deployments of Moonbeam, including the Moonbase Alpha TestNet, Moonriver on Kusama, and Moonbeam on Polkadot. Here's how these environments are named and their corresponding [chain specification file](https://github.com/paritytech/chainspecs) names:
...
- [Using Docker](/moonbeam-mkdocs/node-operators/networks/run-a-node/docker/) - this method provides a quick and easy way to get started with a Docker container
- [Using Systemd](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/) - this method is recommended for those with experience compiling a Substrate node

## Debug, Trace and TxPool APIs {: #debug-trace-txpool-apis }

You can also gain access to some non-standard RPC methods by running a tracing node, which allow developers to inspect and debug transactions during runtime. Tracing nodes use a different Docker image than a standard Moonbase Alpha, Moonriver, or Moonbeam node. Check out the [Run a Tracing Node](/moonbeam-mkdocs/node-operators/networks/tracing-node/) guide and be sure to switch to the right network tab throughout the instructions. Then to interact with your tracing node, check out the [Debug & Trace](/moonbeam-mkdocs/builders/ethereum/json-rpc/debug-trace/) guide.
...
!!! note
    Lazy loading a Moonbeam requires a large number of RPC requests. To avoid being rate-limited by a public endpoint, it's highly recommended to use a [dedicated endpoint](/moonbeam-mkdocs/builders/get-started/endpoints/#endpoint-providers).  
...
Instructions for purging chain data will vary slightly depending on how you spun up your node:
  ...
  - For Docker, you can check out the [Purge Your Node](/moonbeam-mkdocs/node-operators/networks/run-a-node/docker/#purge-your-node) section of the [Using Docker](/moonbeam-mkdocs/node-operators/networks/run-a-node/docker/) page
  - For Systemd, you can take a look at the [Purge Your Node](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/#purge-your-node) section of the [Using Systemd](/moonbeam-mkdocs/node-operators/networks/run-a-node/systemd/) page
...
- Resolved Markdown: https://docs.moonbeam.network/builders/build/runtime-upgrades.md
- Canonical (HTML): https://docs.moonbeam.network/builders/build/runtime-upgrades/
- Summary: A historical record of each runtime upgrade and the block at which the runtime was executed for Moonbeam, Moonriver, and the Moonbase Alpha TestNet.
- Word Count: 1900; Token Estimate: 5382
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:1ea9e02f5eebf0194a026805a244299ee9ac7d5fb304f47443b6b466b4b2be44
...
Page Title: Security Considerations

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/security.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/security/
- Summary: A description of the main differences that Ethereum developers need to understand in terms of security considerations when developing on Moonbeam.
- Word Count: 1767; Token Estimate: 2487
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:c5a034f900a468fbc56cfd4fe63e6315ad3615c2c5e2ba2908a576aa3d34f561

# Security Considerations

## Introduction {: #introduction }

When developing smart contracts on Moonbeam, there are some security considerations to be aware of that do not apply when developing on Ethereum. Moonbeam has several [precompiled contracts](/moonbeam-mkdocs/builders/ethereum/precompiles/), which are Solidity interfaces that enable developers to access Substrate-based functionality through the Ethereum API, but circumventing the EVM. Although the precompiled contracts are designed to improve the developer experience, there can be some unintended consequences that must be considered.
...
A smart contract allows arbitrary execution of another contract when it allows a user to influence its own `call()` and pass in arbitrary call data and/or the `call()`s target. The [`call()` function](https://solidity-by-example.org/call) is made available through the [address data type in Solidity](https://docs.soliditylang.org/en/latest/types.html#address). When the `call()` function is invoked, the target contract is called using the arbitrary call data.
...
![Arbitrary code execution](/moonbeam-mkdocs/images/learn/core-concepts/security/security-1.webp)
...
- Moonbeam [precompiled contracts](/moonbeam-mkdocs/builders/ethereum/precompiles/) such as the Native ERC-20 precompile, XC-20 precompiles, and XCM-related precompiles allow users to manage and transfer assets without requiring access to the EVM. Instead, these actions are done using native Substrate code. So, if your contract holds native tokens or XC-20s and allows arbitrary code execution, these precompiles can be used to drain the balance of the contract, bypassing any security checks that are normally enforced by the EVM
...
To get the encoded call data, you can use any of the [ABI encoding functions outlined in the Solidity docs](https://docs.soliditylang.org/en/latest/units-and-global-variables.html#abi-encoding-and-decoding-functions), including `abi.encodeWithSelector` as seen in the following function:

```solidity
function getBytes(address _erc20Contract, address _arbitraryCallContract, address _to) public view returns (bytes memory)
```

Once you have the encoded call data, you could make an arbitrary call to the [native ERC-20 precompile contract](/moonbeam-mkdocs/builders/ethereum/precompiles/ux/erc20/), set the value of the call to `0`, and pass in the call data in bytes:
...
To get the function selector to whitelist, you can [keccack256 hash](https://emn178.github.io/online-tools/keccak_256.html) the signature of the function.

Once you have the whitelisted function selector, you can use inline assembly to get the function selector from the encoded call data and compare the two selectors using the [require function](https://docs.soliditylang.org/en/v0.8.17/control-structures.html#panic-via-assert-and-error-via-require). If the function selector from the encoded call data matches the whitelisted function selector, you can make the call. Otherwise, an exception will be thrown.
...
To whitelist a given contract, you can use the [require function](https://docs.soliditylang.org/en/v0.8.17/control-structures.html#panic-via-assert-and-error-via-require), which will compare the target contract address to the whitelisted contract address. If the addresses match, the call can be executed. Otherwise, an exception will be thrown.
...
!!! note
    As a [best practice](https://consensysdiligence.github.io/smart-contract-best-practices/development-recommendations/solidity-specific/tx-origin/), `tx.origin` should not be used for authorization. Instead, you should use `msg.sender`.

You can use the [require function](https://docs.soliditylang.org/en/v0.8.17/control-structures.html#panic-via-assert-and-error-via-require) to compare the `tx.origin` and `msg.sender`. If they are the same address, you're ensuring that only EOAs can call the function. If the `msg.sender` is a contract address, an exception will be thrown.
...
On Ethereum, you can use this check to ensure that a given contract function can only be called once by an EOA. This is because on Ethereum, EOAs can only interact with a contract once per transaction. However, **this is not the case** on Moonbeam, as EOAs can interact with a contract multiple times at once by using precompiled contracts, such as the [batch](/moonbeam-mkdocs/builders/ethereum/precompiles/ux/batch/) and [call permit](/moonbeam-mkdocs/builders/ethereum/precompiles/ux/call-permit/) precompiles.
...
Page Title: Setting up a Proxy Account

- Resolved Markdown: https://docs.moonbeam.network/tokens/manage/proxy-accounts.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/manage/proxy-accounts/
- Summary: Learn how to set up a proxy account on Moonbeam-based networks so you can keep your underlying account safe in cold storage.
- Word Count: 2691; Token Estimate: 4213
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:61a891bedf97726d735b840d45f406fbf0101fee5e6e1183f15f6a36439e1578
...
- [Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/explorer) open and connected to Moonbase Alpha
- Create or have two accounts on Moonbase Alpha
- At least one of the accounts must be funded with `DEV` tokens.
 You can get DEV tokens for testing on Moonbase Alpha once every 24 hours from the [Moonbase Alpha Faucet](https://faucet.moonbeam.network)
If you need help importing your accounts into Polkadot.js Apps, please check out the [Interacting with Moonbeam using Polkadot.js Apps](/moonbeam-mkdocs/tokens/connect/polkadotjs/#creating-or-importing-an-h160-account) guide.
...
=== "Moonbeam"
    |    Variable    |                       Value                       |
    |:--------------:|:-------------------------------------------------:|
    |  Deposit base  |  10.08 GLMR  |
    | Deposit factor | 0.21 GLMR |
    |  Max proxies   | 32 proxies |

=== "Moonriver"
    |    Variable    |                       Value                        |
    |:--------------:|:--------------------------------------------------:|
    |  Deposit base  |  1.0008 MOVR  |
    | Deposit factor | 0.0021 MOVR |
    |  Max proxies   | 32 proxies |

=== "Moonbase Alpha"
    |    Variable    |                       Value                       |
    |:--------------:|:-------------------------------------------------:|
    |  Deposit base  |  1.0008 DEV   |
    | Deposit factor | 0.0021 DEV  |
    |  Max proxies   | 32 proxies |
...
- **`IdentityJudgement`** - allows the proxy account to request judgement on an [account's identity](/moonbeam-mkdocs/tokens/manage/identity/) from a registrar. The following judgements can be issued:
...
It's easy to create a proxy account on [the Moonbeam dApp](https://apps.moonbeam.network/moonbeam/proxy). To do so, take the following steps:
...
![Add a proxy account from the Extrinsics page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-2.webp)
...
![Select the Add proxy menu item from the Accounts page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-3.webp)
...
![Add a proxy account from the Accounts page of Polkadot.js Apps](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-4.webp)
...
![Add the details of the proxy account, including the proxy account and type.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-5.webp)
...
When connected to [the Moonbeam dApp](https://apps.moonbeam.network/moonbeam/proxy) with your primary account, you can see a list of accounts with proxy control over your connected primary account in the **Your Proxies** section.

![Verify proxy created via apps.moonbeam.network](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-6.webp)

Alternatively, by connecting the proxy account to [the Moonbeam dApp](https://apps.moonbeam.network/moonbeam/proxy), you can see a list of accounts over which the connected account has proxy control in the **Proxied accounts to you** section.

![Verify proxy control accounts via apps.moonbeam.network](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-7.webp)
...
To check your proxy accounts from the [**Chain state** page](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/chainstate), you can take the following steps:
...
![Verify your proxy accounts via the Extrinsics page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-8.webp)
...
![Hover over the proxy icon to manage your proxies via the Accounts page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-9.webp)

A pop-up will appear where you can view an overview of all of your proxy accounts.

![Review your proxy accounts.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-10.webp)
...
To execute a transaction, navigate back to the [**Extrinsics** page](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/extrinsics) and take the following steps:
...
![Execute a proxy transaction from the Extrinsics page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-11.webp)
...
To remove a proxy account, connect your primary account to [the Moonbeam dApp](https://apps.moonbeam.network/moonbeam/proxy) and press **Remove** next to the proxy account that you want to remove. Alternatively, you can remove all proxy accounts of the primary account with **Remove All Proxies**. In either case, you must confirm the transaction in your wallet. 

![Remove account via Apps.Moonbeam.Network](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-12.webp)
...
To remove a proxy from the [**Extrinsics** page](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#/extrinsics), you can take the following steps:
...
![Remove a proxy account from the Extrinsics page of Polkadot.js Apps](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-13.webp)
...
![Click on the Manage Proxies button to review and manage your proxy accounts.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-14.webp)
...
![Remove a proxy account from the Accounts page of Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/manage/proxy-accounts/proxies-15.webp)
...
Page Title: Solidity Precompiles

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/precompiles/overview.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/precompiles/overview/
- Summary: An overview of the available Solidity precompiles on Moonbeam. Precompiles enable you to interact with Substrate features using the Ethereum API.
- Word Count: 2054; Token Estimate: 6385
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:5ebc25753131f81fbe09df091f8a5bde5d317c0a9ce732ba0e7f1c00973d3303
...
- Resolved Markdown: https://docs.moonbeam.network/learn/features/staking.md
- Canonical (HTML): https://docs.moonbeam.network/learn/features/staking/
- Summary: Moonbeam provides staking features where token holders delegate collator candidates with their tokens and earn rewards.
- Word Count: 1958; Token Estimate: 4095
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:564c98150f80b25ef3f93b09682b56941a68a43de62413fa0812c7bfd0ed3f7a
...
Page Title: Standard Ethereum JSON-RPC Methods

- Resolved Markdown: https://docs.moonbeam.network/builders/ethereum/json-rpc/eth-rpc.md
- Canonical (HTML): https://docs.moonbeam.network/builders/ethereum/json-rpc/eth-rpc/
- Summary: Explore a comprehensive list of standard Ethereum JSON-RPC methods that can be used to interface with Moonbeam nodes programmatically.
- Word Count: 1679; Token Estimate: 3018
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:8d8c38b1047e8471633156bbeb4c2ce56457a822b5c11d86f1fdc0ec47bb6ec4
...
Page Title: Transfer & Monitor Balances on Moonbeam

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/transfers-api.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/transfers-api/
- Summary: A description of the main differences that developers need to understand in terms of the different balance transfers available on Moonbeam compared to Ethereum.
- Word Count: 1218; Token Estimate: 2009
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:2875cfb6b5e32746ec89c5a37bc2e688dddd67472a51ba2916afedd17edb2fa1
...
- Resolved Markdown: https://docs.moonbeam.network/learn/features/treasury.md
- Canonical (HTML): https://docs.moonbeam.network/learn/features/treasury/
- Summary: Moonbeam has an on-chain Treasury controlled by Treasury Council members, enabling stakeholders to submit proposals to further the network.
- Word Count: 623; Token Estimate: 914
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:5f6aca805ffdb79cc1897a0cd0588f083a8b5310de6741552e1246414a5c24d3
...
Page Title: Unified Accounts

- Resolved Markdown: https://docs.moonbeam.network/learn/core-concepts/unified-accounts.md
- Canonical (HTML): https://docs.moonbeam.network/learn/core-concepts/unified-accounts/
- Summary: Moonbeam replaced the default Substrate account system with native support for the Ethereum-based H160 accounts and ECDSA keys. Find out more information!
- Word Count: 637; Token Estimate: 853
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:794252e243db549402c407d2b514500257977519b1d98325ad72974b7b455cfd

# Unified Accounts

## Introduction {: #introduction }

As Moonbeam is designed to be an Ethereum-compatible parachain on Polkadot, the underlying account system replaces the default Substrate-style accounts and keys with Ethereum-style accounts and keys. As a result, you can interact with your Moonbeam account using [MetaMask](/moonbeam-mkdocs/tokens/connect/metamask/) and Ethereum tools you may already be familiar with, such as [Remix](/moonbeam-mkdocs/builders/ethereum/dev-env/remix/) and [Hardhat](/moonbeam-mkdocs/builders/ethereum/dev-env/hardhat/).

You can also interact with your Moonbeam account using Polkadot.js Apps as it natively supports H160 addresses and ECDSA keys. For more information on this integration, you can check out the [Interacting with Moonbeam Using Polkadot.js Apps](/moonbeam-mkdocs/tokens/connect/polkadotjs/) guide.

## Substrate EVM Compatible Blockchain {: #substrate-evm-compatible-blockchain }

Any parachain in the Polkadot ecosystem can offer a full EVM implementation, which provides the possibility of executing Solidity-based smart contracts with minimal to no changes. Substrate makes this integration possible - just plug the [EVM pallet](https://docs.rs/pallet-evm/2.0.1/pallet_evm) into your runtime for EVM support, and the [Ethereum Pallet with Frontier](https://github.com/polkadot-evm/frontier) to have Ethereum RPC compatibility. The availability of these open-source modules that Moonbeam has developed with Parity has led multiple parachains to offer Ethereum compatibility on their chains.
...
![Old account system diagram](/moonbeam-mkdocs/images/learn/core-concepts/unified-accounts/unified-accounts-1.webp)
...
![New account system diagram](/moonbeam-mkdocs/images/learn/core-concepts/unified-accounts/unified-accounts-2.webp)
...
Page Title: Using Talisman with Polkadot JS Apps

- Resolved Markdown: https://docs.moonbeam.network/tokens/connect/talisman.md
- Canonical (HTML): https://docs.moonbeam.network/tokens/connect/talisman/
- Summary: Follow this quick tutorial to learn how to use Moonbeam’s Ethereum-style H160 addresses and send transactions with Polkadot.js Apps and Talisman.
- Word Count: 1764; Token Estimate: 2532
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:2b9f44f8e7f7c84d166619cc91ff7089ebc057820d8d1135e283e27945d5df0f
...
[Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network%2Fpublic-ws#/accounts) supports H160 accounts injected into the browser via an extension like [Talisman](https://talisman.xyz). Note, Polkadot.js Apps is phasing out support for [accounts stored locally in the browser's cache](/moonbeam-mkdocs/tokens/connect/polkadotjs/). While you can continue to use any accounts that you've imported and stored in your browser locally via Polkadot.js Apps, you won't be able to add any new ones. This means that you'll need to use an extension like Talisman. Furthermore, injecting your account from an extension like Talisman is generally regarded to be safer than storing the account directly in the browser.
...
Talisman is a crypto-wallet that natively supports Substrate (Polkadot) and Ethereum accounts. The Talisman wallet browser extension is available on [Google Chrome](https://chromewebstore.google.com/detail/talisman-wallet/fijngjgcjhjmmpcmkeiomlglpeiijkld) and [Brave](https://chromewebstore.google.com/detail/talisman-wallet/fijngjgcjhjmmpcmkeiomlglpeiijkld), and a corresponding asset dashboard is accessible at [app.talisman.xyz](https://app.talisman.xyz)

First, download and install the [Talisman extension](https://talisman.xyz). Once the extension opens up, you'll be prompted to either create a new wallet or import an existing one. For the purposes of this demo, you'll create a new wallet. On the following screen you'll be prompted to create a password to secure the new wallet.  

![Create a new wallet or import an existing one into Talisman.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-1.webp)
...
![Back up your Talisman recovery phrase.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-2.webp)
...
![See your Moonbase Alpha testnet account balances in Talisman.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-3.webp)
...
![Enable Ethereum/Moonbeam accounts in Talisman.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-4.webp)

Your Talisman wallet is now connected to Polkadot.js Apps. After refreshing Polkadot.js Apps, you should see your Talisman account in the [Accounts page of Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network%2Fpublic-ws#/accounts). When launching [Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network%2Fpublic-ws#/accounts) for the first time, you may or may not be connected to the desired network. You can change your selected network to the Moonbase Alpha TestNet by clicking the logo in the top left corner, then scroll down to the **Test Networks** section, select Moonbase Alpha, and scroll back to the top and click **Switch**.

![Connect to Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-5.webp)
...
![Switch to Moonbase Alpha in Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-6.webp)
...
![Create a new Moonbeam account in Talisman.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-7.webp)

Although our new account has been successfully created, Polkadot.js Apps isn't aware of it yet. To connect the new account to Polkadot.js Apps, take the following steps from [Polkadot.js Apps](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network%2Fpublic-ws#/accounts):
...
![Connect Talisman account to Polkadot.js Apps.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-8.webp)
...
![Send a Moonbeam transaction through the Substrate API with Talisman.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-9.webp)

After the transaction is confirmed, you should see the balances updated for each account.

![You can see your balances updated in Polkadot.js Apps after a successful transaction.](/moonbeam-mkdocs/images/tokens/connect/talisman/talisman-10.webp)
...
Page Title: XC-20 Transfers Overview

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc20/send-xc20s/overview.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc20/send-xc20s/overview/
- Summary: Explore the types of asset transfers and some of the fundamentals of remote asset transfers via XCM, including the XCM instructions for asset transfers.
- Word Count: 968; Token Estimate: 1473
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:59b9faf658fea35e8e8c72cbc83ece27db50a8258ba3e3d3e496ef94cf667a1e
...
Page Title: XC-20s and Cross-Chain Assets

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/xc20/overview.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/xc20/overview/
- Summary: Learn about the types of cross-chain assets on Moonbeam, in particular, local and external XC-20s, and view a list of the external XC-20s on Moonbeam.
- Word Count: 2776; Token Estimate: 5956
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:ee1ed9268d0f0d3992860dade7118829960b02069e0fee2e12b5d6bdb17f050d

# Overview of XC-20s

## Introduction {: #introduction }

The [Cross-Consensus Message (XCM)](https://wiki.polkadot.com/learn/learn-xcm/) format provides a universal way for blockchains to exchange messages and transfer assets. To extend this interoperability to the EVM, Moonbeam introduced XC-20s, ERC-20 tokens on Moonbeam that are fully compatible with XCM transfers.
...
This page aims to cover the basics on XC-20s; if you want to learn how to interact with or transfer XC-20s, please refer to the [Send XC-20s guide](/moonbeam-mkdocs/builders/interoperability/xcm/xc20/send-xc20s/overview/).
...
Local XC-20s are all ERC-20s that exist on the EVM, and that can be transferred cross-chain through XCM. For local XC-20s to be transferred to another parachain, the asset must be registered on that chain. When transferring local XC-20s, the underlying tokens reside in the destination chain's Sovereign account on Moonbeam. A [sovereign account](/moonbeam-mkdocs/builders/interoperability/xcm/core-concepts/sovereign-accounts/) is a keyless account governed by a blockchain runtime—rather than an individual—that can hold assets and interact with other chains. Local XC-20s must follow [the ERC-20 interface outlined in this guide](/moonbeam-mkdocs/builders/interoperability/xcm/xc20/interact/#the-erc20-interface). They must implement the standard ERC-20 function signatures, including the correct function selector of the `transfer` function as described in [EIP-20](https://eips.ethereum.org/EIPS/eip-20). However, additional functionality can still be added as long as it doesn’t break the base methods. 
...
From a cross-chain transfer perspective, local and external XC-20s can be sent through Polkadot’s XCM infrastructure using the Ethereum or Substrate API. Because the underlying asset is an ERC-20 with EVM bytecode following the [EIP-20 token standard](https://eips.ethereum.org/EIPS/eip-20), both transfers initiated via the Substrate and Ehereum APIs generate EVM logs visible to EVM-based explorers such as [Moonscan](https://moonscan.io). In contrast, you can't send a regular ERC-20 transfer using the Substrate API. Aside from cross-chain transfers through XCM, all other XC-20 interactions (such as querying balances or adjusting allowances) must occur in the EVM.

Cross-chain transfers of XC-20s are executed via the Polkadot XCM Pallet, which utilizes regular mint, burn, and transfer mechanisms of ERC-20s for the XCM asset flow. If you’d like to learn how to send XC-20s using that pallet, refer to the [Using the Polkadot XCM Pallet](/moonbeam-mkdocs/builders/interoperability/xcm/xc20/send-xc20s/xcm-pallet/) guide.
...
For example, Wormhole-wrapped ETH (wETH) is considered a local reserve asset on Moonbeam, even though Ethereum is the ultimate source of ETH. Once ETH is wrapped by Wormhole and enters the Polkadot ecosystem via Moonbeam, wETH can be transferred to other parachains through [Moonbeam Routed Liquidity (MRL)](/moonbeam-mkdocs/builders/interoperability/mrl/).
...
=== "Moonbeam"
    ...
    |:---------------------:|:---------:|:------------------------------------------------------------------------------------------------------------------------------------:|
    |       Polkadot        |   xcDOT   |  [0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080](https://moonscan.io/token/0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080)  |
    |         Acala         |  xcaUSD   |  [0xfFfFFFFF52C56A9257bB97f4B2b6F7B2D624ecda](https://moonscan.io/token/0xfFfFFFFF52C56A9257bB97f4B2b6F7B2D624ecda)  |
    |         Acala         |   xcACA   |  [0xffffFFffa922Fef94566104a6e5A35a4fCDDAA9f](https://moonscan.io/token/0xffffFFffa922Fef94566104a6e5A35a4fCDDAA9f)  |
    |         Acala         |  xcLDOT   |  [0xFFfFfFffA9cfFfa9834235Fe53f4733F1b8B28d4](https://moonscan.io/token/0xFFfFfFffA9cfFfa9834235Fe53f4733F1b8B28d4)  |
    |        Apillon        |  xcNCTR   |  [0xFfFFfFfF8A9736B44EbF188972725bED67BF694E](https://moonscan.io/token/0xFfFFfFfF8A9736B44EbF188972725bED67BF694E)  |
    |         Astar         |  xcASTR   |  [0xFfFFFfffA893AD19e540E172C10d78D4d479B5Cf](https://moonscan.io/token/0xFfFFFfffA893AD19e540E172C10d78D4d479B5Cf)  |
    |        Bifrost        |   xcBNC   |  [0xFFffffFf7cC06abdF7201b350A1265c62C8601d2](https://moonscan.io/token/0xFFffffFf7cC06abdF7201b350A1265c62C8601d2)  |
    |        Bifrost        |  xcBNCS   |  [0xfFfffffF6aF229AE7f0F4e0188157e189a487D59](https://moonscan.io/token/0xfFfffffF6aF229AE7f0F4e0188157e189a487D59)  |
    |        Bifrost        |   xcFIL   |  [0xfFFfFFFF6C57e17D210DF507c82807149fFd70B2](https://moonscan.io/token/0xfFFfFFFF6C57e17D210DF507c82807149fFd70B2)  |
    |        Bifrost        |  xcvASTR  |  [0xFffFffff55C732C47639231a4C4373245763d26E](https://moonscan.io/token/0xFffFffff55C732C47639231a4C4373245763d26E)  |
    |        Bifrost        |  xcvBNC   |  [0xffFffFff31d724194b6A76e1d639C8787E16796b](https://moonscan.io/token/0xffFffFff31d724194b6A76e1d639C8787E16796b)  |
    |        Bifrost        |  xcvDOT   |  [0xFFFfffFf15e1b7E3dF971DD813Bc394deB899aBf](https://moonscan.io/token/0xFFFfffFf15e1b7E3dF971DD813Bc394deB899aBf)  |
    |        Bifrost        |  xcvFIL   |  [0xFffffFffCd0aD0EA6576B7b285295c85E94cf4c1](https://moonscan.io/token/0xFffffFffCd0aD0EA6576B7b285295c85E94cf4c1)  |
    |        Bifrost        |  xcvGLMR  |  [0xFfFfFFff99dABE1a8De0EA22bAa6FD48fdE96F6c](https://moonscan.io/token/0xFfFfFFff99dABE1a8De0EA22bAa6FD48fdE96F6c)  |
    |        Bifrost        | xcvMANTA  |  [0xFFfFFfFfdA2a05FB50e7ae99275F4341AEd43379](https://moonscan.io/token/0xFFfFFfFfdA2a05FB50e7ae99275F4341AEd43379)  |
    |      Centrifuge       |   xcCFG   |  [0xFFfFfFff44bD9D2FFEE20B25D1Cf9E78Edb6Eae3](https://moonscan.io/token/0xFFfFfFff44bD9D2FFEE20B25D1Cf9E78Edb6Eae3)  |
    |      Composable       | xcIBCMOVR |  [0xFfFfffFF3AFcd2cAd6174387df17180a0362E592](https://moonscan.io/token/0xFfFfffFF3AFcd2cAd6174387df17180a0362E592)  |
    |      Composable       | xcIBCPICA |  [0xfFFFFfFFABe9934e61db3b11be4251E6e869cf59](https://moonscan.io/token/0xfFFFFfFFABe9934e61db3b11be4251E6e869cf59)  |
    |      Composable       | xcIBCIST  |  [0xfFfFffff6A3977d5B65D1044FD744B14D9Cef932](https://moonscan.io/token/0xfFfFffff6A3977d5B65D1044FD744B14D9Cef932)  |
    |      Composable       | xcIBCBLD  |  [0xFffFffff9664be0234ea4dc64558F695C4f2A9EE](https://moonscan.io/token/0xFffFffff9664be0234ea4dc64558F695C4f2A9EE)  |
    |      Composable       | xcIBCTIA  |  [0xFFFfFfff644a12F6F01b754987D175F5A780A75B](https://moonscan.io/token/0xFFFfFfff644a12F6F01b754987D175F5A780A75B)  |
    |      Composable       | xcIBCATOM |  [0xffFFFffF6807D5082ff2f6F86BdE409245e2D953](https://moonscan.io/token/0xffFFFffF6807D5082ff2f6F86BdE409245e2D953)  |
    |       Darwinia        |  xcRING   |  [0xFfffFfff5e90e365eDcA87fB4c8306Df1E91464f](https://moonscan.io/token/0xFfffFfff5e90e365eDcA87fB4c8306Df1E91464f)  |
    |          DED          |   xcDED   |  [0xfFffFFFf5da2d7214D268375cf8fb1715705FdC6](https://moonscan.io/token/0xfFffFFFf5da2d7214D268375cf8fb1715705FdC6)  |
    |      Equilibrium      |   xcEQ    |  [0xFffFFfFf8f6267e040D8a0638C576dfBa4F0F6D6](https://moonscan.io/token/0xFffFFfFf8f6267e040D8a0638C576dfBa4F0F6D6)  |
    |      Equilibrium      |   xcEQD   |  [0xFFffFfFF8cdA1707bAF23834d211B08726B1E499](https://moonscan.io/token/0xFFffFfFF8cdA1707bAF23834d211B08726B1E499)  |
    |        HydraDX        |   xcHDX   |  [0xFFFfFfff345Dc44DDAE98Df024Eb494321E73FcC](https://moonscan.io/token/0xFFFfFfff345Dc44DDAE98Df024Eb494321E73FcC)  |
    |       Interlay        |  xcIBTC   |  [0xFFFFFfFf5AC1f9A51A93F5C527385edF7Fe98A52](https://moonscan.io/token/0xFFFFFfFf5AC1f9A51A93F5C527385edF7Fe98A52)  |
    |       Interlay        |  xcINTR   |  [0xFffFFFFF4C1cbCd97597339702436d4F18a375Ab](https://moonscan.io/token/0xFffFFFFF4C1cbCd97597339702436d4F18a375Ab)  |
    |         Manta         |  xcMANTA  |  [0xfFFffFFf7D3875460d4509eb8d0362c611B4E841](https://moonscan.io/token/0xfFFffFFf7D3875460d4509eb8d0362c611B4E841)  |
    |         Nodle         |  xcNODL   |  [0xfffffffFe896ba7Cb118b9Fa571c6dC0a99dEfF1](https://moonscan.io/token/0xfffffffFe896ba7Cb118b9Fa571c6dC0a99dEfF1)  |
    | OriginTrail Parachain |  xcNEURO  |  [0xFfffffFfB3229c8E7657eABEA704d5e75246e544](https://moonscan.io/token/0xFfffffFfB3229c8E7657eABEA704d5e75246e544)  |
    |       Parallel        |  xcPARA   |  [0xFfFffFFF18898CB5Fe1E88E668152B4f4052A947](https://moonscan.io/token/0xFfFffFFF18898CB5Fe1E88E668152B4f4052A947)  |
    |         LAOS          |  xcLAOS   |  [0xfffFFffFdd704e8e824a5EEc47de88f5B9e13588](https://moonscan.io/token/0xfffFFffFdd704e8e824a5EEc47de88f5B9e13588)  |
    |        Moonriver      |  MOVR.mr  |  [0xFfffFffF54c47F43713fd9211724362697f1a302](https://moonscan.io/token/0xFfffFffF54c47F43713fd9211724362697f1a302)  |
    |         Peaq          |  xcPEAQ   |  [0xFffFFFFFEC4908b74688a01374f789B48E9a3eab](https://moonscan.io/token/0xFffFFFFFEC4908b74688a01374f789B48E9a3eab)  |
    |       Pendulum        |   xcPEN   |  [0xffFFfFFf2257622F345E1ACDe0D4f46D7d1D77D0](https://moonscan.io/token/0xffFFfFFf2257622F345E1ACDe0D4f46D7d1D77D0)  |
    |       Pendulum        | xcEURC.s  |  [0xFfFfffFfa608Ec1332131289cBD8A97a0bB3D90F](https://moonscan.io/token/0xFfFfffFfa608Ec1332131289cBD8A97a0bB3D90F)  |
    |         Phala         |   xcPHA   |  [0xFFFfFfFf63d24eCc8eB8a7b5D0803e900F7b6cED](https://moonscan.io/token/0xFFFfFfFf63d24eCc8eB8a7b5D0803e900F7b6cED)  |
    |       Polkadex        |  xcPDEX   |  [0xfFffFFFF43e0d9b84010b1b67bA501bc81e33C7A](https://moonscan.io/token/0xfFffFFFF43e0d9b84010b1b67bA501bc81e33C7A)  |
    |  Polkadot Asset Hub   |  xcPINK   |  [0xfFfFFfFf30478fAFBE935e466da114E14fB3563d](https://moonscan.io/token/0xfFfFFfFf30478fAFBE935e466da114E14fB3563d)  |
    |  Polkadot Asset Hub   |  xcSTINK  |  [0xFffFffFf54c556bD1d0F64ec6c78f1B477525E56](https://moonscan.io/token/0xFffFffFf54c556bD1d0F64ec6c78f1B477525E56)  |
    |  Polkadot Asset Hub   |  xcUSDC   |  [0xFFfffffF7D2B0B761Af01Ca8e25242976ac0aD7D](https://moonscan.io/token/0xFFfffffF7D2B0B761Af01Ca8e25242976ac0aD7D)  |
    |  Polkadot Asset Hub   |  xcUSDT   |  [0xFFFFFFfFea09FB06d082fd1275CD48b191cbCD1d](https://moonscan.io/token/0xFFFFFFfFea09FB06d082fd1275CD48b191cbCD1d)  |
    |  Polkadot Asset Hub   |  xcWIFD   |  [0xfffffffF2e1D1ac9eA1686255bEfe995B31abc96](https://moonscan.io/token/0xfffffffF2e1D1ac9eA1686255bEfe995B31abc96)  |
    |      Snowbridge       |   DAI.e   |  [0xfFfffFFf9DE12E6658C49B4834f9278f6A39f5d7](https://moonscan.io/token/0xfFfffFFf9DE12E6658C49B4834f9278f6A39f5d7)  |
    |      Snowbridge       |   ETH.e   |  [0xFFFfFFffaFF6dF83d0A1935dDA2e5F1F402C0c45](https://moonscan.io/token/0xFFFfFFffaFF6dF83d0A1935dDA2e5F1F402C0c45)  |
    |      Snowbridge       |  USDC.e   |  [0xfffFFFFF166F84967F054AE95ab5764c38Cf3aEd](https://moonscan.io/token/0xfffFFFFF166F84967F054AE95ab5764c38Cf3aEd)  |
    |      Snowbridge       |  USDT.e   |  [0xFFffFfff7bc304425217b49E9598415C514ae81B](https://moonscan.io/token/0xFFffFfff7bc304425217b49E9598415C514ae81B)  |
    |      Snowbridge       |  WBTC.e   | [0xfFffFFFf1B4Bb1ac5749F73D866FfC91a3432c47](https://moonscan.io/address/0xffffffff1B4BB1AC5749F73D866FFC91A3432C47) |
    |      Snowbridge       | wstETH.e  |  [0xFfFFFfFF5D5DEB44BF7278DEE5381BEB24CB6573](https://moonscan.io/token/0xFfFFFfFF5D5DEB44BF7278DEE5381BEB24CB6573)  |
    |      Snowbridge       |  WETH.e   |  [0xfFffFFFF86829AFE1521AD2296719DF3ACE8DED7](https://moonscan.io/token/0xfFffFFFF86829AFE1521AD2296719DF3ACE8DED7)  |
    |       Subsocial       |   xcSUB   |  [0xfFfFffFf43B4560Bc0C451a3386E082bff50aC90](https://moonscan.io/token/0xfFfFffFf43B4560Bc0C451a3386E082bff50aC90)  |
    |        Unique         |   xcUNQ   |  [0xFffffFFFD58f77E6693CFB99EbE273d73C678DC2](https://moonscan.io/token/0xFffffFFFD58f77E6693CFB99EbE273d73C678DC2)  |
    |       Zeitgeist       |   xcZTG   |  [0xFFFFfffF71815ab6142E0E20c7259126C6B40612](https://moonscan.io/token/0xFFFFfffF71815ab6142E0E20c7259126C6B40612)  |

     _*You can check each [Asset ID](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbeam.network#assets) on Polkadot.js Apps_

=== "Moonriver"
    |      Origin      | Symbol  |                                                                XC-20 Address                                                                 |
    |:----------------:|:-------:|:--------------------------------------------------------------------------------------------------------------------------------------------:|
    |      Kusama      |  xcKSM  | [0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080](https://moonriver.moonscan.io/token/0xffffffff1fcacbd218edc0eba20fc2308c778080) |
    |     Bifrost      |  xcBNC  | [0xFFfFFfFFF075423be54811EcB478e911F22dDe7D](https://moonriver.moonscan.io/token/0xFFfFFfFFF075423be54811EcB478e911F22dDe7D) |
    |     Bifrost      | xcvBNC  | [0xFFffffff3646A00f78caDf8883c5A2791BfCDdc4](https://moonriver.moonscan.io/token/0xFFffffff3646A00f78caDf8883c5A2791BfCDdc4) |
    |     Bifrost      | xcvKSM  | [0xFFffffFFC6DEec7Fc8B11A2C8ddE9a59F8c62EFe](https://moonriver.moonscan.io/token/0xFFffffFFC6DEec7Fc8B11A2C8ddE9a59F8c62EFe) |
    |     Bifrost      | xcvMOVR | [0xfFfffFfF98e37bF6a393504b5aDC5B53B4D0ba11](https://moonriver.moonscan.io/token/0xfFfffFfF98e37bF6a393504b5aDC5B53B4D0ba11) |
    |     Calamari     |  xcKMA  | [0xffffffffA083189F870640B141AE1E882C2B5BAD](https://moonriver.moonscan.io/token/0xffffffffA083189F870640B141AE1E882C2B5BAD) |
    |       Crab       | xcCRAB  | [0xFFFffFfF8283448b3cB519Ca4732F2ddDC6A6165](https://moonriver.moonscan.io/token/0xFFFffFfF8283448b3cB519Ca4732F2ddDC6A6165) |
    |   Crust-Shadow   |  xcCSM  | [0xffFfFFFf519811215E05eFA24830Eebe9c43aCD7](https://moonriver.moonscan.io/token/0xffFfFFFf519811215E05eFA24830Eebe9c43aCD7) |
    |      Heiko       |  xcHKO  | [0xffffffFF394054BCDa1902B6A6436840435655a3](https://moonriver.moonscan.io/token/0xffffffFF394054BCDa1902B6A6436840435655a3) |
    |    Integritee    | xcTEER  | [0xFfFfffFf4F0CD46769550E5938F6beE2F5d4ef1e](https://moonriver.moonscan.io/token/0xFfFfffFf4F0CD46769550E5938F6beE2F5d4ef1e) |
    |      Karura      |  xcKAR  | [0xFfFFFFfF08220AD2E6e157f26eD8bD22A336A0A5](https://moonriver.moonscan.io/token/0xFfFFFFfF08220AD2E6e157f26eD8bD22A336A0A5) |
    |      Karura      | xcaSEED | [0xFfFffFFfa1B026a00FbAA67c86D5d1d5BF8D8228](https://moonriver.moonscan.io/token/0xFfFffFFfa1B026a00FbAA67c86D5d1d5BF8D8228) |
    |      Khala       |  xcPHA  | [0xffFfFFff8E6b63d9e447B6d4C45BDA8AF9dc9603](https://moonriver.moonscan.io/token/0xffFfFFff8E6b63d9e447B6d4C45BDA8AF9dc9603) |
    |     Kintsugi     | xcKINT  | [0xfffFFFFF83F4f317d3cbF6EC6250AeC3697b3fF2](https://moonriver.moonscan.io/token/0xfffFFFFF83F4f317d3cbF6EC6250AeC3697b3fF2) |
    |     Kintsugi     | xcKBTC  | [0xFFFfFfFfF6E528AD57184579beeE00c5d5e646F0](https://moonriver.moonscan.io/token/0xFFFfFfFfF6E528AD57184579beeE00c5d5e646F0) |
    | Kusama Asset Hub | xcRMRK  | [0xffffffFF893264794d9d57E1E0E21E0042aF5A0A](https://moonriver.moonscan.io/token/0xffffffFF893264794d9d57E1E0E21E0042aF5A0A) |
    | Kusama Asset Hub | xcUSDT  | [0xFFFFFFfFea09FB06d082fd1275CD48b191cbCD1d](https://moonriver.moonscan.io/token/0xFFFFFFfFea09FB06d082fd1275CD48b191cbCD1d) |
    |      Litmus      |  xcLIT  | [0xfffFFfFF31103d490325BB0a8E40eF62e2F614C0](https://moonriver.moonscan.io/token/0xfffFFfFF31103d490325BB0a8E40eF62e2F614C0) |
    |     Mangata      |  xcMGX  | [0xffFfFffF58d867EEa1Ce5126A4769542116324e9](https://moonriver.moonscan.io/token/0xffFfFffF58d867EEa1Ce5126A4769542116324e9) |
    |     Picasso      | xcPICA  | [0xFffFfFFf7dD9B9C60ac83e49D7E3E1f7A1370aD2](https://moonriver.moonscan.io/token/0xFffFfFFf7dD9B9C60ac83e49D7E3E1f7A1370aD2) |
    |    Robonomics    |  xcXRT  | [0xFffFFffF51470Dca3dbe535bD2880a9CcDBc6Bd9](https://moonriver.moonscan.io/token/0xFffFFffF51470Dca3dbe535bD2880a9CcDBc6Bd9) |
    |      Shiden      |  xcSDN  | [0xFFFfffFF0Ca324C842330521525E7De111F38972](https://moonriver.moonscan.io/token/0xFFFfffFF0Ca324C842330521525E7De111F38972) |
    |    Tinkernet     | xcTNKR  | [0xfFFfFffF683474B842852111cc31d470bD8f5081](https://moonriver.moonscan.io/token/0xffffffff683474b842852111cc31d470bd8f5081) |
    |      Turing      |  xcTUR  | [0xfFffffFf6448d0746f2a66342B67ef9CAf89478E](https://moonriver.moonscan.io/token/0xfFffffFf6448d0746f2a66342B67ef9CAf89478E) |
    |     Moonbeam     | GLMR.mb | [0xFfFffFff1a49463978f19dfD6983f2fa1885C254](https://moonriver.moonscan.io/token/0xFfFffFff1a49463978f19dfD6983f2fa1885C254) |
    |     Moonbeam     |xcUSDC.mb| [0xFFFFFFfF2215880E56fe63a96E54E073757C3092](https://moonriver.moonscan.io/token/0xFFFFFFfF2215880E56fe63a96E54E073757C3092) |
    |     Moonbeam     |xcUSDT.mb| [0xFFFFFFFFc70260a3bf46A91cF87B6F5e6Abba712](https://moonriver.moonscan.io/token/0xFFFFFFFFc70260a3bf46A91cF87B6F5e6Abba712) |
    |     Moonbeam     |whUSDC.mb| [0xFfFfffff9E27Ab60FADFd33ABf71B39A7445f7eD](https://moonriver.moonscan.io/token/0xFfFfffff9E27Ab60FADFd33ABf71B39A7445f7eD) |

    _*You can check each [Asset ID](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonriver.moonbeam.network#assets) on Polkadot.js Apps_

=== "Moonbase Alpha"
    |        Origin        | Symbol |                                                                XC-20 Address                                                                |
    |:--------------------:|:------:|:-------------------------------------------------------------------------------------------------------------------------------------------:|
    | Relay Chain Alphanet | xcUNIT | [0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080](https://moonbase.moonscan.io/token/0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080) |

     _*You can check each [Asset ID](https://polkadot.js.org/apps/?rpc=wss://wss.api.moonbase.moonbeam.network#assets) on Polkadot.js Apps_

### Retrieve List of External XC-20s and Their Metadata {: #list-xchain-assets }

To fetch a list of the currently available external XC-20s along with their associated metadata, you can query the chain state using the [Polkadot.js API](/moonbeam-mkdocs/builders/substrate/libraries/polkadot-js-api/). You'll take the following steps:
...
The following is an example that retrieves the asset metadata for the [Jupiter token](https://moonbase.moonscan.io/token/0x9aac6fb41773af877a2be73c99897f3ddfacf576) on Moonbase Alpha:
...
Page Title: XCM Instructions

- Resolved Markdown: https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/instructions.md
- Canonical (HTML): https://docs.moonbeam.network/builders/interoperability/xcm/core-concepts/instructions/
- Summary: When XCM instructions are combined, they form an XCM message that performs a cross-chain action. Take a look at some of the most common instructions.
- Word Count: 820; Token Estimate: 1264
- Last Updated: 2026-05-21T21:21:53+00:00
- Version Hash: sha256:44561e9974cc719cd76d9a0c533b60f171287856830e3898b78511a6656bb3bd
